...
export const PACKAGES = [
...

  {
    ...
    faqs:[
      ...
      {q:'Is the Kedarnath trek mandatory?', a:'No. The 16 km from Gaurikund can be done on foot, by pony (' + KEDARNATH_TREK.pony.oneWay + '), palki (' + KEDARNATH_TREK.palki.band + ' per booking) or helicopter (from ₹3,043 one way, official IRCTC fare). We book any of these for you. Most fit pilgrims walk up and ride down; senior travellers usually take the pony both ways.'},
...

  {
    ...
    metaTitle: 'Senior Citizen Char Dham Yatra 12N/13D | Pony & Palki',
