...
export const metadata = {
  ...
  description: 'Complete Kedarnath Temple guide 2026. Temple history, darshan timings (4 AM–9 PM), dress code, puja types, altitude 3,583m, trek route from Gaurikund. Opening date: April 22, 2026.',
...
export default function KedarnathTemple() {
  return (<>
    ...
    <article style={{ maxWidth:900, margin:'0 auto', padding:'40px 20px 60px' }}>
      ...
      <p style={p}>Kedarnath is one of the twelve <strong>Jyotirlingas</strong> of Lord Shiva — the most sacred manifestations of the divine in Shaivite tradition. Located at 3,583 metres above sea level in the Rudraprayag district of Uttarakhand, the temple sits at the head of the Mandakini river valley, surrounded by snow-capped peaks. The existing stone temple is believed to have been built by Adi Shankaracharya in the 8th century CE, though the site's spiritual significance dates to the Mahabharata period — the Pandavas are said to have worshipped Lord Shiva here after the Kurukshetra war.</p>
      <p style={p}>The temple survived the catastrophic 2013 floods with remarkably little structural damage — a massive boulder from the mountain behind acted as a natural shield, deflecting the floodwaters around the shrine. Many devotees see this as a divine miracle. The temple has since been restored with a stronger infrastructure including a wider trek path, proper drainage, and emergency facilities.</p>
      ...
      <div style={{ background:'#fff', borderRadius:12, border:'1px solid var(--border)', overflow:'hidden', marginBottom:28 }}>
        {[['4:00 AM – 6:00 AM','Mahabhishek Puja — premium puja, advance booking required'],['6:00 AM – 7:00 AM','Balabhog (morning offering)'],['7:00 AM – 8:00 AM','Madhyan Darshan (general)'],['8:00 AM – 12:00 PM','General Darshan — peak hours'],['12:00 PM – 2:00 PM','Madhyan Mahabhishek + Sahastra Naam Archana'],['2:00 PM – 5:00 PM','Temple closed for break'],['5:00 PM – 7:00 PM','Panchomukhi Darshan'],['7:30 PM – 8:30 PM','Shringaar Aarti'],['8:30 PM – 9:00 PM','Shayan Aarti — temple closes for the night'],].map(([time,desc],i)=>(
          <div key={i} style={{ display:'grid', gridTemplateColumns:'160px 1fr', borderTop: i>0?'1px solid var(--border)':'none', padding:'11px 16px', background: i%2===0?'#fff':'var(--bg)' }}>
      ...
      <div style={{ background:'var(--navy)', borderRadius:16, padding:'26px 24px', textAlign:'center' }}>
        ...
        <div style={{ display:'flex', gap:10, justifyContent:'center', flexWrap:'wrap' }}>
          <a href={`https://wa.me/${SITE.whatsapp}?text=${encodeURIComponent('Namaste! I want to book Kedarnath Yatra with puja booking assistance.')}`} target="_blank" rel="noopener noreferrer" style={{ background:'#25D366', color:'#fff', padding:'11px 24px', borderRadius:9, fontWeight:700, fontSize:13.5, textDecoration:'none' }}>💬 WhatsApp</a>
