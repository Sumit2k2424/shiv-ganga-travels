...
export const metadata = {
  ...
  openGraph: {
    title: `Direct Operator vs Travel Aggregator — Char Dham Yatra ${SITE.season}`,
    description: 'What you pay extra for when booking through an aggregator vs a local operator. How the Char Dham booking market works.',
...
const DIRECT_FLOW = [
  { step: '1', who: 'You', action: 'Pay ₹13,900 directly to Shiv Ganga Travels' },
  { step: '2', who: 'Operator', action: 'Receives full ₹13,900 · Allocates to vehicle, hotels, guide, margins' },
  ...
  return (
    <>
      ...
      <article style={{ maxWidth: 900, margin: '0 auto', padding: '36px 20px 60px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 24 }}>
          {[
            { num: '1', title: 'Ask for Uttarakhand Tourism registration', detail: 'Every legitimate operator in Uttarakhand is registered with the UTDB. Ask for the registration number and verify at uttarakhandtourism.gov.in before you pay anything.' },
        ...
        {[
          ...
          ['Is booking Char Dham directly cheaper than using MakeMyTrip?', 'Yes, typically by 15–30%. Aggregators add 10–20% commission. For a ₹13,900 operator price, you pay ₹22,000–24,000 on an aggregator. Direct with Shiv Ganga Travels you pay ₹13,900 and get the same — often better — service.'],
          ['How do I know Shiv Ganga Travels is a legitimate direct operator?', `Our office is at Saptrishi Road, Bhupatwala, Haridwar — you can visit. We have ${SITE.reviews.count} public Google reviews at a ${SITE.reviews.rating}/5 rating. We issue GST invoices under GSTIN ${SITE.gstin} — verifiable at gst.gov.in. Our WhatsApp number (+91-7817996730) is answered by the same people running your yatra.`],
        ...
        <div style={{ marginTop: 28, paddingTop: 20, borderTop: '1px solid hsl(var(--border))' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
            ...
            <Link href="/char-dham-yatra" style={{ background: 'var(--navy)', color: '#fff', padding: '8px 14px', borderRadius: 8, fontSize: 13, fontWeight: 700, textDecoration: 'none' }}>Book Direct — ₹13,900 →</Link>
          </div>
        </div>
        ...
        <div style={{ background: 'var(--navy)', borderRadius: 16, padding: '28px 24px', textAlign: 'center', marginTop: 36 }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: 13.5, marginBottom: 18 }}>Direct booking · ₹13,900/person · Zero commission · Haridwar office</p>
