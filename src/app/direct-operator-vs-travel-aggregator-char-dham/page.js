    ...
    <>
      ...
      <article style={{ maxWidth: 900, margin: '0 auto', padding: '36px 20px 60px' }}>
        ...
        {[
          ...
          ['How do I know Shiv Ganga Travels is a legitimate direct operator?', `Our office is at Saptrishi Road, Bhupatwala, Haridwar — you can visit. We have ${SITE.reviews.count} public Google reviews at a ${SITE.reviews.rating}/5 rating. We issue GST-compliant invoices. Our WhatsApp number (+91-7817996730) is answered by the same people running your yatra.`],
