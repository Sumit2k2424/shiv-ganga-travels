...
const DIRECT_FLOW = [
  { step: '1', who: 'You', action: 'Pay ₹18,500 directly to Shiv Ganga Travels' },
  { step: '2', who: 'Operator', action: 'Receives full ₹18,500 · Allocates to vehicle, hotels, guide, margins' },
    ...
    <>
      ...
      <article style={{ maxWidth: 900, margin: '0 auto', padding: '36px 20px 60px' }}>
        ...
        {[
          ...
          ['Is booking Char Dham directly cheaper than using MakeMyTrip?', 'Yes, typically by 15–30%. Aggregators add 10–20% commission. For a ₹18,500 operator price, you pay ₹22,000–24,000 on an aggregator. Direct with Shiv Ganga Travels you pay ₹18,500 and get the same — often better — service.'],
        ...
        <div style={{ background: 'var(--navy)', borderRadius: 16, padding: '28px 24px', textAlign: 'center', marginTop: 36 }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: 13.5, marginBottom: 18 }}>Direct booking · ₹18,500/person · Zero commission · Haridwar office</p>
