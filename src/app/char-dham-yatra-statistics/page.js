    ...
    <>
      ...
      <article style={{ maxWidth:980, margin:'0 auto', padding:'40px 20px 60px' }}>
        ...
        <div style={{ fontSize:12.5, color:'var(--text-muted)', marginBottom:24 }}>
          <strong>Last updated:</strong> May 26, 2026 · <strong>Source:</strong> Shiv Ganga Travels operator data (2010–2026), cross-referenced with Uttarakhand Tourism, Devasthanam Board, and Char Dham Yatra Authority notifications.
        </div>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fill,minmax(150px,1fr))', gap:12, marginBottom:36 }}>
          ...
          <Stat value="₹19,500" label="Median Direct-Operator Package Cost" source="2026 booking data" />
        </div>
