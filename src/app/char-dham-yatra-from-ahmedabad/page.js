...
export const metadata = {
  ...
  openGraph: {
    title: `Char Dham Yatra from Ahmedabad ${SITE.season} — Trains, Flights & Packages from ₹23,999`,
    ...
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: `Char Dham Yatra ${SITE.season} from Ahmedabad — Shiv Ganga Travels` }],
  },
  twitter: {
...
const PAA = [
  { q:'How far is Char Dham Yatra from Ahmedabad?', a:'Ahmedabad to Haridwar — the gateway to the dhams — is roughly 1,100 km. The full Char Dham circuit then covers about 1,100–1,400 km from Haridwar and back.' },
  { q:'How do I reach Haridwar from Ahmedabad?', a:'From Ahmedabad it\'s about 1,100 km to Haridwar. Best options: train (14–16 hrs) or fly to Dehradun. Jolly Grant Airport, Dehradun is the nearest airport (35 km from Haridwar); Haridwar Junction is the nearest railhead. From there the circuit begins.' },
  { q:'How many days are needed for Char Dham Yatra from Ahmedabad?', a:'Plan 10–12 days for the full road circuit including travel from Ahmedabad. By helicopter (flying from Dehradun) the on-ground portion drops to 5–6 days. Senior citizens should allow a couple of extra days for acclimatisation.' },
  { q:'What is the cost of Char Dham Yatra from Ahmedabad?', a:'Our all-inclusive road packages start from ₹23,999 per person, covering vehicle from Haridwar, hotels, meals, guide, VIP darshan and free registration. The helicopter package runs about ₹2.2–2.4 lakh. Train or flight fare to Haridwar/Dehradun is usually separate.' },
  { q:'What is the best time for Char Dham Yatra from Ahmedabad?', a:'May–June and September–October, matching the temple season — the 2026 dhams open between April 19 and 23. Book early for these peak windows and avoid the July–August monsoon, when landslides can delay the mountain stretches.' },
    ...
    <>
      ...
      <article style={{ maxWidth:900, margin:'0 auto', padding:'40px 20px 60px' }}>
        ...
        <div style={{ display:'flex', gap:8, flexWrap:'wrap', marginBottom:28 }}>
          <span key='Ahmedabad Railway Station' style={{ background:'#fff',border:'1px solid hsl(var(--border))',color:'var(--navy)',padding:'7px 14px',borderRadius:8,fontSize:12.5,fontWeight:600 }}>📍 Ahmedabad Railway Station</span>
          <span key='Sardar Vallabhbhai Patel International Airport' style={{ background:'#fff',border:'1px solid hsl(var(--border))',color:'var(--navy)',padding:'7px 14px',borderRadius:8,fontSize:12.5,fontWeight:600 }}>📍 Sardar Vallabhbhai Patel International Airport</span>
          <span key='Maninagar Station' style={{ background:'#fff',border:'1px solid hsl(var(--border))',color:'var(--navy)',padding:'7px 14px',borderRadius:8,fontSize:12.5,fontWeight:600 }}>📍 Maninagar Station</span>
        </div>
        ...
        <div style={{ borderTop:'1px solid hsl(var(--border))', paddingTop:24, marginTop:32 }}>
          ...
          <PeopleAlsoAsk items={PAA}/>
              ...
              <CityLinkMesh current="ahmedabad" />
      </article>
    </>
  );
}
