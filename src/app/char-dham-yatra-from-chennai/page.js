...
export const metadata = {
  title: 'Char Dham Yatra from Chennai 2026 — Train, Flight & Package from ₹25,999',
  description: 'Char Dham Yatra from Chennai 2026. 2,200 km — fly only. Trains, flights, pickups explained. All-inclusive packages from ₹25,999. Direct Haridwar operator since 2010.',
  keywords: ['char dham yatra from chennai','char dham yatra package from chennai','chennai to haridwar char dham','char dham tour from chennai 2026','chardham yatra chennai','chennai char dham yatra package'],
...
function Schema() {
  const faq = {
    ...
    mainEntity:[
      { '@type':'Question', name:'How to reach Haridwar from Chennai for Char Dham Yatra?', acceptedAnswer:{ '@type':'Answer', text:'Chennai (MAA) to Dehradun — no direct flight. Best: fly Chennai to Delhi (2h 15m, ₹3,000–6,000) and connect to Haridwar by Shatabdi or taxi. Total travel: one full day. IndiGo and Air India have multiple daily MAA–DEL flights.' } },
      { '@type':'Question', name:'What is the Char Dham Yatra package cost from Chennai?', acceptedAnswer:{ '@type':'Answer', text:'Char Dham Yatra from Chennai starts at ₹25,999/person for a 9N/10D all-inclusive package — AC vehicle, hotels, meals, VIP darshan at all 4 dhams, guide, registration. Zero commission.' } },
      { '@type':'Question', name:'How many days for Char Dham Yatra from Chennai?', acceptedAnswer:{ '@type':'Answer', text:'Plan 11–13 days from Chennai: 1 day travel to Haridwar + 9–10 days Char Dham circuit + 1–2 days return.' } },
    ],
  };
  const bc = {
    ...
    itemListElement:[
      ...
      { '@type':'ListItem', position:3, name:'From Chennai', item:`${SITE.baseUrl}/char-dham-yatra-from-chennai` },
    ],
  };
    ...
    <>
      ...
      <section style={{ background:'linear-gradient(145deg,var(--navy) 0%,#1A3E75 60%,var(--teal) 100%)', padding:'52px 20px 40px', textAlign:'center' }}>
        <div style={{ maxWidth:860, margin:'0 auto' }}>
          <span style={{ background:'rgba(232,146,10,0.18)', color:'#FFD166', fontSize:11, fontWeight:700, letterSpacing:'0.12em', textTransform:'uppercase', padding:'5px 16px', borderRadius:100, display:'inline-block', marginBottom:14 }}>
            Chennai · Char Dham 2026 · Direct Operator
          </span>
          ...
          <p style={{ color:'rgba(255,255,255,0.85)', fontSize:15, lineHeight:1.7, maxWidth:680, margin:'0 auto 20px' }}>
            2,200 km — fly only · All-inclusive from <strong style={{ color:'#FFD166' }}>{ '₹25,999' }/person</strong> · Zero commission
          </p>
      ...
      <article style={{ maxWidth:900, margin:'0 auto', padding:'40px 20px 60px' }}>
        ...
        <div style={{ background:'var(--navy)', borderRadius:14, padding:'18px 20px', marginBottom:28, display:'grid', gridTemplateColumns:'repeat(auto-fill,minmax(140px,1fr))', gap:10 }}>
          {[['Distance','2200 km'],['Best route','Fly to Dehradun/Delhi'],['Total trip','11–13 days'],['Package from','₹25,999/person'],['Season 2026','Apr 19 – Nov'],['Registration','FREE · We handle']].map(([k,v])=>(
        ...
        <p style={p}><strong>Char Dham Yatra from Chennai 2026:</strong> The distance from Chennai to Haridwar is approximately 2200km. Chennai (MAA) to Dehradun — no direct flight. Best: fly Chennai to Delhi (2h 15m, ₹3,000–6,000) and connect to Haridwar by Shatabdi or taxi. Total travel: one full day. IndiGo and Air India have multiple daily MAA–DEL flights. Our all-inclusive 9N/10D package from Chennai is ₹25,999/person — covers the full circuit with AC vehicle, hotels, meals, VIP darshan, and guide. Everything on this page is specific to Chennai pilgrims.</p>

        <h2 style={h2}>How to Reach Haridwar from Chennai</h2>
        <p style={p}>All our packages start from Haridwar. Getting there from Chennai is your first step. Actual train names, timings and costs below:</p>
        ...
        <div style={{ overflowX:'auto', marginBottom:20 }}>
          <table style={{ width:'100%', borderCollapse:'collapse', fontSize:13 }}>
            ...
            <tbody>
              {[
                ['Grand Trunk Express (12615)','Chennai Central','07:00 AM','Delhi → Haridwar','~38h + 6h total','₹1,500–5,000',''],
        ...
        <div style={{ background:'#EEF6FF', border:'1px solid #B5D4F4', borderRadius:10, padding:'12px 16px', marginBottom:20 }}>
          ...
          <div style={{ fontSize:13.5, color:'#185FA5', lineHeight:1.7 }}>Chennai (MAA) to Dehradun — no direct flight. Best: fly Chennai to Delhi (2h 15m, ₹3,000–6,000) and connect to Haridwar by Shatabdi or taxi. Total travel: one full day. IndiGo and Air India have multiple daily MAA–DEL flights.</div>
        </div>
        ...
        <div style={{ background:'#fff', borderRadius:10, padding:'14px 16px', border:'1px solid var(--border)', borderLeft:'3px solid var(--teal)', marginBottom:20 }}>
          <div style={{ fontWeight:700, fontSize:13.5, color:'var(--navy)', marginBottom:6 }}>🚗 By Road from Chennai</div>
          <div style={{ fontSize:13.5, color:'#475569', lineHeight:1.7 }}>Chennai pilgrims almost always fly. The most efficient route is the morning Chennai–Delhi flight catching the 6:45 PM Jan Shatabdi to Haridwar. Arrive midnight, check in, Ganga Aarti next morning.</div>
        </div>
        ...
        <div style={{ background:'rgba(232,146,10,0.07)', border:'1px solid rgba(232,146,10,0.25)', borderRadius:10, padding:'14px 16px', marginBottom:28 }}>
          <div style={{ fontWeight:700, fontSize:13, color:'#7B3F00', marginBottom:4 }}>💡 What we know about Chennai pilgrims (15 years of experience)</div>
          <div style={{ fontSize:13.5, color:'#7B3F00', lineHeight:1.7 }}>Tamil Nadu sends a significant number of Char Dham pilgrims — especially from the Iyengar and Iyer communities with Vaishnava and Shaiva connections to Badrinath and Kedarnath respectively. September–October is peak demand.</div>
        </div>

        <h2 style={h2}>What's Included — Chennai Char Dham Package</h2>
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))', gap:8, marginBottom:24 }}>
          {['✅ AC vehicle (Innova / Tempo Traveller)','✅ Station or airport pickup in Chennai or Haridwar','✅ Hotel accommodation all 9 nights (twin sharing)','✅ Breakfast + dinner every day','✅ VIP darshan — no queue at all 4 dhams','✅ Experienced Garhwali guide throughout','✅ Biometric registration handled — completely free','✅ All tolls, parking, driver allowance included','✅ Oxygen cylinder + first aid kit on vehicle','✅ 24hr WhatsApp support during the entire yatra'].map(item=>(
        ...
        <div style={{ background:'rgba(29,158,117,0.08)', border:'1px solid #1D9E75', borderRadius:10, padding:'12px 16px', marginBottom:24, fontSize:13.5, color:'#0F5132' }}>
          <strong>Package from Chennai:</strong> ₹25,999/person · 9N/10D · All-inclusive · 5% GST included · Zero commission — you pay us directly
        </div>

        <h2 style={h2}>Our Pickup Points in Chennai</h2>
        <p style={p}>We pick up from these Chennai locations. If you are at a different address, WhatsApp us — we accommodate almost all requests.</p>
        <div style={{ display:'flex', gap:8, flexWrap:'wrap', marginBottom:28 }}>
          <span key='Chennai International Airport T1/T2' style={{ background:'#fff',border:'1px solid var(--border)',color:'var(--navy)',padding:'7px 14px',borderRadius:8,fontSize:12.5,fontWeight:600 }}>📍 Chennai International Airport T1/T2</span>
          ...
          <span key='Egmore Station' style={{ background:'#fff',border:'1px solid var(--border)',color:'var(--navy)',padding:'7px 14px',borderRadius:8,fontSize:12.5,fontWeight:600 }}>📍 Egmore Station</span>
        </div>
        ...
        <div style={{ background:'var(--navy)', borderRadius:16, padding:'28px 24px', textAlign:'center', marginTop:32 }}>
          <div style={{ color:'#FFD166', fontSize:13, fontWeight:700, marginBottom:6 }}>🙏 Chennai → Haridwar → Char Dham</div>
          <h3 style={{ color:'#fff', fontFamily:'var(--font-display)', fontSize:'1.3rem', marginBottom:8 }}>Book Your Char Dham Yatra from Chennai</h3>
