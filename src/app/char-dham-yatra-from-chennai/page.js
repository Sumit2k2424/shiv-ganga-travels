...
export const metadata = {
  title: 'Char Dham Yatra from Chennai 2026 — Train,',
  description: 'Char Dham Yatra from Chennai 2026. 2,200 km — fly only. Trains, flights, pickups explained. All-inclusive packages from ₹25,999.',
