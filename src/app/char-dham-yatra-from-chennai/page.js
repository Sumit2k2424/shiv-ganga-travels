...
export const metadata = {
  title: 'Char Dham Yatra Package from Chennai 2026 — Flight, Train & All-Inclusive Tours',
  description: 'Char Dham Yatra from Chennai 2026. Flight to Dehradun (2.5 hrs). Packages from ₹27,499. Tamil-speaking guide available on request. VIP darshan. Zero commission.',
      ...
      <section style={{ background:'linear-gradient(145deg,var(--navy) 0%,var(--navy-mid) 60%,var(--teal) 100%)', padding:'56px 20px 44px', textAlign:'center' }}>
        <div style={{ maxWidth:820, margin:'0 auto' }}>
          ...
          <div style={{ display:'flex', gap:12, justifyContent:'center', flexWrap:'wrap', marginTop:24 }}>
            <a href={`https://wa.me/${SITE.whatsapp}?text=${encodeURIComponent('Namaste! I want to book Char Dham Yatra 2026 from Chennai.')}`} target="_blank" rel="noopener noreferrer"
