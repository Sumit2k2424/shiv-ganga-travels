...
function Schema() {
  ...
  const faq = {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'How to book Char Dham Yatra without an agent or aggregator?', acceptedAnswer: { '@type': 'Answer', text: 'Book directly with a Haridwar-based operator like Shiv Ganga Travels. Call or WhatsApp +91-7017082807. You get the same vehicles and service without the 10–20% commission markup. Prices start from ₹19,500 per person (9N/10D, all-inclusive). You also get a direct phone number for the operator managing your yatra — not a call centre.' } },
    ...
    <>
      ...
      <article style={{ maxWidth: 900, margin: '0 auto', padding: '36px 20px 60px' }}>
        ...
        {[
          ...
          ['How to book Char Dham Yatra without an agent?', 'Book directly with a Haridwar-based operator like Shiv Ganga Travels. Call or WhatsApp +91-7017082807. You get the same vehicles and service without the commission markup. Packages from ₹19,500/person all-inclusive.'],
