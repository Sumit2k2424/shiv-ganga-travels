  ...
  return (
    <>
      ...
      <article style={{ maxWidth:900, margin:'0 auto', padding:'40px 20px 60px' }}>
        <p style="font-size:15px;color:var(--text-mid);line-height:1.85;margin-bottom:16px">Yamunotri, at 3,291 metres in the Uttarkashi district, is the source of the Yamuna river and the westernmost of the four Char Dhams. It is always the first shrine visited in the traditional Char Dham Yatra circuit, before Gangotri, Kedarnath, and Badrinath. The temple enshrines a black marble idol of Goddess Yamuna.</p>
        <h2 style="font-family:var(--font-display);font-size:1.5rem;font-weight:600;color:var(--navy);margin:28px 0 12px">The Yamunotri Trek</h2>
        <p style="font-size:15px;color:var(--text-mid);line-height:1.85;margin-bottom:16px">The trek starts at <strong>Janki Chatti</strong> (2,650m) and covers <strong>6 km one way</strong> to the temple (3,291m), with an elevation gain of about 640 metres. Most pilgrims take 2–3 hours to ascend and 1.5–2 hours to descend. Compared to the Kedarnath trek, this is considerably shorter and gentler.</p>
        <p style="font-size:15px;color:var(--text-mid);line-height:1.85;margin-bottom:16px">Ponies are available at Janki Chatti for those who cannot or prefer not to trek, at approximately ₹1,800–2,500 one way. Palki (palanquin) is also available at ₹4,000–6,000 one way.</p>
        <h2 style="font-family:var(--font-display);font-size:1.5rem;font-weight:600;color:var(--navy);margin:28px 0 12px">Surya Kund — The Boiling Hot Spring</h2>
        <p style="font-size:15px;color:var(--text-mid);line-height:1.85;margin-bottom:16px">One of the most unusual experiences at Yamunotri is the <strong>Surya Kund</strong> — a natural hot spring that remains at approximately 94°C year-round. Pilgrims traditionally cook rice and potatoes wrapped in cloth by submerging them in the Surya Kund, and offer the cooked food as prasad to Goddess Yamuna. It's a ritual you won't find anywhere else in the four dhams.</p>
