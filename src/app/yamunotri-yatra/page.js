  ...
  return (
    <>
      ...
      <article style={{ maxWidth:900, margin:'0 auto', padding:'40px 20px 60px' }}>
        ...
        <p style={{fontSize:'15px',color:'var(--text-mid)',lineHeight:1.85,marginBottom:'16px'}}>Ponies are available at Janki Chatti for those who cannot or prefer not to trek, at approximately {YAMUNOTRI_TREK.pony.oneWay} one way. A doli (palanquin, four porters) is also available at {YAMUNOTRI_TREK.doli.oneWay} one way.</p>
        ...
        <div style={{ background:'var(--navy)', borderRadius:16, padding:'28px 24px', textAlign:'center', marginTop:36 }}>
          ...
          <div style={{ display:'flex', gap:12, justifyContent:'center', flexWrap:'wrap' }}>
            <a href={`https://wa.me/${SITE.whatsapp}?text=${encodeURIComponent('Namaste! I want to book Yamunotri Yatra 2026 — First Dham of the Char Dham Circuit.')}`} target="_blank" rel="nofollow noopener noreferrer"
        ...
        <TempleLinkMesh groups={MESH.yamunotri} label="Yamunotri deep-dive guides" />
