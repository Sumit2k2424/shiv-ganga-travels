    ...
    <article style={{ maxWidth:900, margin:'0 auto', padding:'40px 20px 60px' }}>
      ...
      <div style={{ background:'var(--navy-light)', borderRadius:14, padding:'18px 20px', marginBottom:24 }}>
        ...
        <div style={{ display:'flex', flexWrap:'wrap', gap:8 }}>
          {[{l:'Do Dham Package (Kedar+Badri)',h:'/do-dham-yatra'},{l:'Devprayag Sangam',h:'/devprayag'},{l:'Guptkashi Guide',h:'/guptkashi-guide'},{l:'Gaurikund Guide',h:'/gaurikund-guide'},{l:'Chopta Tungnath',h:'/chopta-tungnath'},{l:'Char Dham Route Map',h:'/char-dham-yatra-route-map'},{l:'Haridwar → Badrinath Distance',h:'/haridwar-to-badrinath-distance'},{l:'Delhi → Kedarnath Distance',h:'/delhi-to-kedarnath-distance'},{l:'Altitude Sickness Guide',h:'/altitude-sickness-char-dham'}].map(l=>(
