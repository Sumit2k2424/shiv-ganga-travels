      ...
      <article style={{ maxWidth: 900, margin: '0 auto', padding: '40px 20px 60px' }}>
        ...
        <div style={{ borderTop: '1px solid hsl(var(--border))', paddingTop: 24, marginTop: 32 }}>
          ...
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
            {[['Devprayag Sangam', '/devprayag'], ['Dhari Devi Temple', '/dhari-devi-temple'], ['Guptkashi Guide', '/guptkashi-guide'], ['Gaurikund Guide', '/gaurikund-guide'], ['Kedarnath Yatra', '/kedarnath-yatra'], ['Badrinath Yatra', '/badrinath-yatra'], ['Char Dham Yatra', '/char-dham-yatra'], ['Do Dham Yatra', '/do-dham-yatra'], ['Teen Dham Yatra', '/teen-dham-yatra'], ['Panch Kedar Yatra', '/panch-kedar-yatra'], ['Char Dham Route Map', '/char-dham-yatra-route-map'], ['Kedarnath to Badrinath', '/kedarnath-to-badrinath-distance'], ['Road Status', '/char-dham-road-status'], ['Chopta & Tungnath', '/chopta-tungnath'], ['Taxi from Haridwar', '/taxi-service-in-haridwar'], ['Char Dham from Haridwar', '/char-dham-yatra-from-haridwar']].map(([l, href]) => (
