...
const PAGE_DATES = pageDates('/devprayag');
...
const PRAYAGS = [
  ...
  { n: '3', name: 'Karnaprayag', rivers: 'Alaknanda + Pindar', alt: '860 m', near: 'Junction for the Kumaon road' },
  { n: '4', name: 'Rudraprayag', rivers: 'Alaknanda + Mandakini', alt: '690 m', near: 'Where the Kedarnath road splits off', href: '/rudraprayag' },
