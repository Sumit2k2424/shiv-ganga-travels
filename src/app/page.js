            ...
            <div className="why-split-image" style={{ position:'relative', borderRadius:'var(--r-xl)', overflow:'hidden', height:420 }}>
              ...
              <div style={{ position:'absolute', bottom:20, left:20, right:20 }}>
                <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(min(100%,280px),1fr))', gap:10 }}>
                  {[{v:'50,000+',l:'Happy Pilgrims'},{v:'15+',l:'Years of Trust'},{v:'4.7/5',l:'Google Rating'},{v:'100%',l:'Safe Record'}].map(s=>(
          ...
          <div style={{ marginBottom:32 }}>
            ...
            <div className='pkg-dir-grid' style={{ display:'grid', gridTemplateColumns:'repeat(auto-fill,minmax(180px,1fr))', gap:10 }}>
              {[
                ...
                { img:'https://images.pexels.com/photos/17008126/pexels-photo-17008126.jpeg?auto=compress&cs=tinysrgb&w=400&h=260&fit=crop', title:'Gangotri Yatra', desc:'2N/3D · From ₹5,299', href:'/gangotri-yatra' },
                { img:'https://images.pexels.com/photos/30924430/pexels-photo-30924430.jpeg?auto=compress&cs=tinysrgb&w=400&h=260&fit=crop', title:'Yamunotri Yatra', desc:'2N/3D · From ₹5,499', href:'/yamunotri-yatra' },
                { img:'https://images.pexels.com/photos/34912011/pexels-photo-34912011.jpeg?auto=compress&cs=tinysrgb&w=400&h=260&fit=crop', title:'Helicopter Package', desc:'All 4 dhams in 6 days', href:'/char-dham-helicopter' },
                { img:'https://images.pexels.com/photos/34376161/pexels-photo-34376161.jpeg?auto=compress&cs=tinysrgb&w=400&h=260&fit=crop', title:'Panch Kedar Yatra', desc:'5 Shiva temples · 8N/9D', href:'/panch-kedar-yatra' },
