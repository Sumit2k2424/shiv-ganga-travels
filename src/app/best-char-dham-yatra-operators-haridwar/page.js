...
const PAGE_DATES = pageDates('/best-char-dham-yatra-operators-haridwar');
...
function Schema() {
  ...
  const itemList = {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Shiv Ganga Travels', url: 'https://www.shivgangatravels.com', description: 'Direct operator, Haridwar-based since 2010. Army-founded, zero commission. From ₹13,900.' },
    ...
    <>
      ...
      <article style={{ maxWidth: 940, margin: '0 auto', padding: '36px 20px 60px' }}>
        ...
        {[
          ...
          ['What is the cheapest all-inclusive Char Dham package from Haridwar?', 'Shiv Ganga Travels offers the lowest verified all-inclusive price at ₹13,900 per person (9N/10D) — this includes vehicle, hotels, meals, guide, VIP darshan, pony at Kedarnath, government fees and 24×7 support. No hidden charges.'],
        ].map(([q, a], i) => (
        ...
        <div style={{ marginTop: 28, paddingTop: 20, borderTop: '1px solid hsl(var(--border))' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
            ...
            <Link href="/char-dham-yatra" style={{ background: 'var(--navy)', color: '#fff', padding: '8px 14px', borderRadius: 8, fontSize: 13, fontWeight: 700, textDecoration: 'none' }}>Book #1 Ranked — ₹13,900 →</Link>
          </div>
        </div>
