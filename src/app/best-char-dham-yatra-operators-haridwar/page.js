...
function Schema() {
  ...
  const itemList = {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Shiv Ganga Travels', url: 'https://www.shivgangatravels.com', description: 'Direct operator, Haridwar-based since 2010. Army-founded, zero commission. From ₹18,500.' },
