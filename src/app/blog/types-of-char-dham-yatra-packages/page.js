...
function Schema() {
  const article = {
    ...
    '@type': 'Article',
    headline: 'Types of Char Dham Yatra Packages 2026 – Budget, Deluxe, Luxury & Helicopter Compared',
    description: '',
    ...
    mainEntityOfPage: `${SITE.baseUrl}/blog/types-of-char-dham-yatra-packages`,
  };
