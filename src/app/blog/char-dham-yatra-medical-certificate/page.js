    ...
    <>
      ...
      <nav style={{ background:'var(--bg)', borderBottom:'1px solid hsl(var(--border))', padding:'9px 20px' }}>
        <div style={{ maxWidth:'var(--container)', margin:'0 auto', fontSize:12, color:'var(--text-muted)', display:'flex', gap:6, flexWrap:'wrap' }}>
          ...
          <Link prefetch={false} href="/blog/char-dham-yatra-registration" style={{ color:'var(--teal)', textDecoration:'none' }}>Registration</Link><span>›</span>
      ...
      <article className="blog-container" itemScope itemType="https://schema.org/Article">
        ...
        <AnswerBox>
          <strong>A <OfficialLink k="health">medical fitness certificate</OfficialLink> is mandatory for every pilgrim aged 55 and over</strong>, uploaded during <OfficialLink k="registration">Char Dham registration</OfficialLink>. Any registered doctor can issue it — you do not need a large hospital — and it should confirm you are fit for altitudes above 3,000m. Below 55 it is not required, but anyone with a cardiac, respiratory or blood-pressure condition should carry a doctor's note and their own medication regardless of what the rules demand.
        </AnswerBox>
