  ...
  const faq = {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'What should the Char Dham Yatra medical certificate say?',
        acceptedAnswer: { '@type': 'Answer', text: 'The certificate must include: (1) Pilgrim's full name as per Aadhaar, (2) Age and date of birth, (3) Statement: "The above patient is physically and medically fit for high-altitude travel to Kedarnath/Char Dham Yatra", (4) Any current medications being taken, (5) Doctor's name, registration number, clinic address, signature, and date. The date must be within 30 days of the yatra start date.' }},
    ...
    <>
      ...
      <nav style={{ background:'var(--bg)', borderBottom:'1px solid var(--border)', padding:'9px 20px' }}>
        <div style={{ maxWidth:'var(--container)', margin:'0 auto', fontSize:12, color:'var(--text-muted)', display:'flex', gap:6, flexWrap:'wrap' }}>
          ...
          <Link href="/blog/char-dham-yatra-registration" style={{ color:'var(--navy)', textDecoration:'none' }}>Registration</Link><span>›</span>
