...
const FAQS = [
  ...
  { cat:'About Shiv Ganga Travels', q:'Who is the founder of Shiv Ganga Travels?',
    a:'Shiv Ganga Travels was founded in 2010 by Dhanesh Chandra Mishra, a retired Indian Army officer. He built the company on the principle that everyone deserves fair pricing — a school teacher from Agra and a corporate executive from Mumbai should pay the same price for the same service. Today, Shiv Ganga Travels operates from Haridwar with 20+ AC vehicles and has served 50,000+ pilgrims.' },
