      ...
      <div style={{ background:'var(--bg)', borderLeft:'4px solid var(--gold)', borderRadius:12, padding:'16px 18px', margin:'0 0 24px' }}>
        ...
        <div style={{ background:'var(--navy-light)', borderRadius:12, padding:'16px 20px', marginBottom:24 }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(min(100%,280px),1fr))', gap:12 }}>
            {[['Opening Date','April 22, 2026 at 8:00 AM'],['Closing Date','November 11, 2026 (Bhai Dooj)'],['Best Season','May 10 – June 20 & Sep 15 – Oct 25'],['Daily Pilgrim Limit','Set each season through registration']].map(([k,v])=>(
