...
function Schema() {
  const article = {
    ...
    '@type': 'Article',
    headline: 'Kedarnath Darshan Timings 2026 – Morning & Evening Sessions, Aarti Time & VIP Darshan',
    description: '',
    ...
    mainEntityOfPage: `${SITE.baseUrl}/blog/kedarnath-darshan-timing`,
  };
  ...
  return (
    <>
      ...
      <article className="blog-container" itemScope itemType="https://schema.org/Article">
        ...
        <div style={{ fontSize:12, color:'var(--text-muted)', marginBottom:20, textAlign:'right' }}>🗓️ <strong>Last updated:</strong> May 21, 2026 · Verified for current season</div>
