...
const ROAD_UPDATED = 'September 1, 2026';
const ROAD_UPDATED_ISO = '2026-09-01';
...
export default function RoadConditions() {
  const routes = [
    ...
    },
    {
      ...
      tip: 'Some operators park at Sitapur or Phata (cheaper parking) instead of Sonprayag; Sonprayag is closer to Gaurikund. On the Phata helipad: Kedarnath helicopter services have been suspended since July 1, 2026 for the monsoon under DGCA guidance, and on August 29 the Rudraprayag DM confirmed they are being prepared to resume on September 15 after a DGCA inspection in the first week of September, with booking dates to follow. Plan on the trek, pony or palki until that inspection clears.',
    },
    {
    ...
    <>
      ...
      <article className="blog-container" itemScope itemType="https://schema.org/Article">
        ...
        <div style={{ background: '#FFF8ED', border: '1px solid #F5D9A8', borderRadius: 12, padding: '14px 16px', marginBottom: 24, fontSize: 13.5, color: '#9A6B1F' }}>
          <strong>Monsoon Status ({ROAD_UPDATED}):</strong> All four routes are open and the yatra is into its second phase, the post-monsoon stretch running to the November closing dates. There has been no state-wide halt since the two-day pause of July 28–29. On August 6, debris blocked the Badrinath highway near Helang (Chamoli), the Gangotri highway (NH-34) near Dharasu Nalu Pani, and the Yamunotri highway (NH-134) near Silai Bend and at Syanachatti; crews cleared all three the same day, and those remain the last blockages we can confirm. The rain has not stopped: IMD forecast heavy to very heavy rain over Dehradun, Bageshwar, Chamoli and Nainital on August 31, and for September 1 heavy rain at isolated places across Pauri, Uttarkashi, Rudraprayag, Chamoli, Bageshwar, Nainital, Champawat and Haridwar — a spell that, unlike mid-August, names all three yatra districts. The State Emergency Operations Centre has directed that trekking not be permitted during active rainfall, so expect a Gaurikund start to be held at the barrier during a downpour. Kedarnath helicopter services, suspended since July 1, are being prepared to resume on September 15: the Rudraprayag DM confirmed on August 29 that a DGCA team inspects in the first week of September and services resume after it. Treat that as the plan, not a fixed date, and plan on the trek, pony or palki until it clears. Night driving is banned 10 PM–4 AM on all Char Dham routes. Verify conditions the morning you travel — police helpline 112 / 1070, or check our <Link href="/char-dham-road-status" style={{ color:'#9A6B1F', fontWeight:700 }}>live road status page</Link>, and read our <Link href="/blog/char-dham-monsoon-safety" style={{ color:'#9A6B1F', fontWeight:700 }}>monsoon safety guide</Link> for how we plan departures around the rain.
        </div>
