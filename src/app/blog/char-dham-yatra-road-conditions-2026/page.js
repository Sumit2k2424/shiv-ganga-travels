...
function Schema() {
  const article = {
    ...
    '@type': 'Article',
    headline: 'Char Dham Yatra Road Conditions 2026 – Route Status, Landslide Zones & Highway Update',
    description: '',
    ...
    mainEntityOfPage: `${SITE.baseUrl}/blog/char-dham-yatra-road-conditions-2026`,
  };
