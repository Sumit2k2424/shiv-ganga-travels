...
export const metadata = {
  title: { absolute: 'चार धाम यात्रा का खर्चा | पूरी जानकारी' },
  ...
  openGraph: { title: `चार धाम यात्रा ${SITE.season} में कितना पैसा लगता है? — हरिद्वार से पूरा खर्चा`, description: `हरिद्वार से चार धाम यात्रा ${SITE.season} में 1 आदमी का खर्चा ₹13,900 से शुरू। गाड़ी, होटल, खाना, पंजीकरण — सब का अलग-अलग हिसाब।`, url: `${SITE.baseUrl}/blog/char-dham-yatra-kitna-kharcha`, type: 'article', 
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: `चार धाम यात्रा ${SITE.season} में कितना पैसा लगता है? — हरिद्वार से पूरा खर्चा` }],
  },
};
  ...
  return (
    <>
      ...
      <article className="blog-container" lang="hi" itemScope itemType="https://schema.org/Article">
        ...
        <p style={p}>जब भी घर में चार धाम यात्रा की बात होती है, पहला सवाल यही उठता है — <strong>"कितना पैसा लगेगा?"</strong> और यह सवाल बिल्कुल सही है। इस लेख में हम आपको पूरा सच बताएंगे — हर मद का हिसाब, कोई छुपा खर्चा नहीं।</p>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13.5 }}>
            ...
            <tbody>
              {[
                ...
                ['सीनियर स्पेशल','₹21,000','12-13 दिन','यमुनोत्री में घोड़ा शामिल, ग्राउंड फ्लोर कमरा'],
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 24 }}>
          {[
            ...
            { icon:'🐴', item:'केदारनाथ घोड़ा (एक तरफ)', cost:KEDARNATH_TREK.pony.oneWay, detail:'गौरीकुंड से 16 km के लिए। 60+ उम्र के लिए जरूरी। हमारे सीनियर पैकेज में शामिल।' },
            { icon:'🐴', item:'यमुनोत्री घोड़ा (एक तरफ)', cost:YAMUNOTRI_TREK.pony.oneWay, detail:'जानकी चट्टी से 6 km के लिए। वैकल्पिक लेकिन बुजुर्गों के लिए सलाहनीय।' },
