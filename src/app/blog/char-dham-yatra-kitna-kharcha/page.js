...
export const metadata = {
  title: 'चार धाम यात्रा 2026 में कितना खर्चा आता है? हरिद्वार से पूरा हिसाब',
  description: 'हरिद्वार से चार धाम यात्रा 2026 में 1 आदमी का खर्चा ₹19,500 से शुरू। गाड़ी, होटल, खाना, पंजीकरण — सब का अलग-अलग हिसाब देखें।',
  keywords: ['चार धाम यात्रा 2026 खर्चा','char dham yatra kitna kharcha','हरिद्वार से चार धाम यात्रा कितने रुपये','char dham yatra cost hindi'],
  alternates: { canonical: `${SITE.baseUrl}/blog/char-dham-yatra-kitna-kharcha` },
  openGraph: { title: 'चार धाम यात्रा 2026 में कितना पैसा लगता है? — हरिद्वार से पूरा खर्चा', description: 'हरिद्वार से चार धाम यात्रा 2026 में 1 आदमी का खर्चा ₹19,500 से शुरू। गाड़ी, होटल, खाना, पंजीकरण — सब का अलग-अलग हिसाब।', url: `${SITE.baseUrl}/blog/char-dham-yatra-kitna-kharcha`, type: 'article' },
};
...
function Schema() {
  const faq = {
    ...
    mainEntity: [
      { '@type': 'Question', name: 'चार धाम यात्रा में कितना पैसा लगता है?', acceptedAnswer: { '@type': 'Answer', text: 'हरिद्वार से चार धाम यात्रा 2026 में प्रति व्यक्ति ₹19,500 से ₹28,000 तक खर्चा होता है। इसमें गाड़ी, होटल, खाना, VIP दर्शन और गाइड शामिल हैं। केदारनाथ घोड़ा (₹3,500–4,500) अलग से लग सकता है।' } },
  ...
  const article = { '@context': 'https://schema.org', '@type': 'Article', headline: 'चार धाम यात्रा 2026 में कितना खर्चा आता है?', inLanguage: 'hi', author: { '@type': 'Organization', name: SITE.name, url: SITE.baseUrl }, datePublished: '2026-05-01', dateModified: '2026-05-14', publisher: { '@type': 'Organization', name: SITE.name }, mainEntityOfPage: { '@type': 'WebPage', '@id': `${SITE.baseUrl}/blog/char-dham-yatra-kitna-kharcha` } };
      ...
      <article style={{ maxWidth: 900, margin: '0 auto', padding: '40px 20px 60px' }}>
        ...
        <div style={{ background: 'var(--navy)', borderRadius: 14, padding: '20px 24px', marginBottom: 28 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(150px,1fr))', gap: 10 }}>
            {[['पैकेज (9N/10D)','₹19,500–₹27,500'],['केदारनाथ घोड़ा','₹3,500–₹4,500'],['पंजीकरण','मुफ्त (₹0)'],['ट्रेन दिल्ली–हरिद्वार','₹200–₹700'],['10 दिन खाने-पीने का','₹1,500–₹3,000'],['कुल (बजट यात्री)','₹22,000–₹28,000']].map(([k,v]) => (
        ...
        <div style={{ overflowX: 'auto', marginBottom: 28 }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13.5 }}>
            ...
            <tbody>
              {[
                ['बजट पैकेज','₹19,500','10-11 दिन','साझा टेम्पो, बजट होटल, खाना, VIP दर्शन'],
                ['डीलक्स पैकेज','₹27,500','11-12 दिन','प्राइवेट इनोवा, 3-स्टार होटल, गाइड'],
        ...
        <p style={{ ...p, fontSize: 13.5, background: 'rgba(29,158,117,0.08)', padding: '12px 16px', borderRadius: 8, borderLeft: '3px solid #1D9E75' }}>
          <strong>शिव गंगा ट्रेवल्स का बेसिक पैकेज ₹19,500 से शुरू होता है</strong> — इसमें गाड़ी, होटल, खाना, गाइड और VIP दर्शन सब शामिल हैं। कोई छुपा खर्चा नहीं।
        </p>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13.5 }}>
            ...
            <tbody>
              {[
                ...
                ['शिव गंगा ट्रेवल्स पैकेज (₹19,500 × 4)','₹78,000'],
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13.5 }}>
            ...
            <tbody>
              {[
                ...
                ['शिव गंगा ट्रेवल्स (सीधे)','₹19,500','0% (शून्य)'],
              ].map(([ch,price,comm],i) => (
