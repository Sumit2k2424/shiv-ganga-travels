...
export const metadata = {
  title: { absolute: `Char Dham Yatra by Train ${SITE.season} | Stations & Best Routes` },
  description: `Char Dham Yatra by train ${SITE.season} — nearest stations, IRCTC tips. Trusted operator, 15+ yrs experience, fixed departures & instant confirmation.`,
  keywords: ['char dham yatra by train','nearest railway station to char dham','haridwar railway station char dham','train to char dham yatra','how to reach haridwar by train',`char dham yatra train package ${SITE.season}`],
  alternates: { canonical: `${SITE.baseUrl}/blog/char-dham-yatra-by-train` },
  openGraph: { title: `Char Dham Yatra by Train ${SITE.season} — Nearest Stations & Routes`, description: 'Nearest railheads, best trains from major cities, IRCTC tips, and how the yatra starts once you reach Haridwar.', url: `${SITE.baseUrl}/blog/char-dham-yatra-by-train`, type: 'article', images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: `Char Dham Yatra by Train ${SITE.season} | Shiv Ganga Travels` }] },
};
