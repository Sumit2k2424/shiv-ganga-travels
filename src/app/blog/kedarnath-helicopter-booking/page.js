  ...
  return (
    <>
      ...
      <article className="blog-container" itemScope itemType="https://schema.org/Article">
        ...
        <p style={{ fontSize:15.5, color:'#334155', lineHeight:1.85, marginBottom:16 }}>Fares are fixed per helipad by the Uttarakhand Civil Aviation Development Authority (<OfficialLink k="ucada">UCADA</OfficialLink>) and charged <strong>per person</strong>. The difference reflects distance from Kedarnath, not service quality — Sersi is closest and cheapest, Guptkashi farthest and priciest. The round-trip fares already include 5% GST; the one-way figures are the base fare before it (₹6,077 × 2 + 5% = ₹12,762). A fuel surcharge and the IRCTC convenience fee are added at checkout. The real ticket below shows both.</p>
