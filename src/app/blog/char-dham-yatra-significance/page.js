...
function Schema() {
  const article = {
    ...
    '@type': 'Article',
    headline: 'Char Dham Yatra History & Spiritual Significance – Why Adi Shankaracharya Founded It',
    description: '',
    ...
    mainEntityOfPage: `${SITE.baseUrl}/blog/char-dham-yatra-significance`,
  };
