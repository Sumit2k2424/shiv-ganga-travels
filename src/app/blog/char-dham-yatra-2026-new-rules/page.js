...
export const metadata = {
  title: 'Char Dham Yatra 2026 New Rules — Phone Ban, Age Limit, IRCTC Helicopter & All Updates',
...
function Schema() {
  ...
  const article = { '@context':'https://schema.org','@type':'NewsArticle', headline:'Char Dham Yatra 2026 New Rules — Phone Ban, Age Limit, IRCTC Helicopter', author:{'@type':'Organization',name:SITE.name,url:SITE.baseUrl}, publisher:{'@type':'Organization',name:SITE.name,url:SITE.baseUrl,logo:{'@type':'ImageObject',url:`${SITE.baseUrl}/logo.png`}}, datePublished:'2026-04-19', dateModified:'2026-04-27', mainEntityOfPage:`${SITE.baseUrl}/blog/char-dham-yatra-2026-new-rules` };
