...
const WEATHER = [
  ...
  { month:'November (to close)', kedarnath:'−5 to 5°C · snow likely',             badrinath:'2 to 6°C · closes 13 Nov',       gangotri:'−1 to 4°C · closes 10 Nov',          yamunotri:'2 to 5°C · closes 11 Nov',           pilgrim:'Very low',            suitability:'Severe. Closing ceremonies on Diwali and Bhai Dooj; roads can shut for snow with a day\'s notice.', verdict:'⭐⭐' },
];
