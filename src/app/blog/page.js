...
const POSTS = [
  ...
  { slug:'char-dham-yatra-budget-vs-premium', title:'Char Dham Budget vs Premium Package — What Actually Changes', excerpt:'Honest comparison: ₹21,000 vs ₹50,000 per person. Hotels, vehicles, darshan quality — what changes and what doesn\'t.', tag:'Budget Guide', readTime:'6 min', icon:'💼' },
  ...
  { slug:'char-dham-yatra-kitna-kharcha', title:'चार धाम यात्रा 2026 में कितना पैसा लगता है? — हरिद्वार से पूरा खर्चा', excerpt:'गाड़ी, होटल, खाना, पंजीकरण, घोड़ा — हर मद का अलग-अलग हिसाब। 4 लोगों की फैमिली का असली उदाहरण। ₹21,000 से शुरू।', tag:'हिंदी गाइड', readTime:'7 min', icon:'💰' },
