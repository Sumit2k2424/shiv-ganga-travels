...
const ALL_POSTS = [
  ...
  { slug:'kedarnath-pony-vs-helicopter', title:'Kedarnath Pony vs Helicopter — Cost & Honest Verdict', excerpt:'Pony ' + KEDARNATH_TREK.pony.oneWay + ' against a helicopter seat from ₹3,043 one way. Time, comfort, weather risk, and which one suits your age and fitness.', tag:'Helicopter', readTime:'6 min', icon:'🐎' },
  { slug:'char-dham-yatra-closing-dates-2026', title:'Char Dham Closing Dates 2026 — All 4 Temples', excerpt:'Gangotri Nov 10, Yamunotri Nov 11, Kedarnath Nov 11 on Bhai Dooj, Badrinath ~Nov 13 (tentative). Plan the last-visit window properly.', tag:'2026 Update', readTime:'5 min', icon:'🔒' },
  ...
  { slug:'haridwar-to-kedarnath', title:'Haridwar to Kedarnath — Complete Route Guide 2026', excerpt:'235km by road + 16km trek. Key stops, journey times, overnight stays, and everything in between.', tag:'Route Guide', readTime:'5 min', icon:'🗺️' },
  ...
  { slug:'char-dham-yatra-kitna-kharcha', title:'चार धाम यात्रा 2026 में कितना पैसा लगता है? — हरिद्वार से पूरा खर्चा', excerpt:'गाड़ी, होटल, खाना, पंजीकरण, घोड़ा — हर मद का अलग-अलग हिसाब। 4 लोगों की फैमिली का असली उदाहरण। ₹13,900 से शुरू।', tag:'हिंदी गाइड', readTime:'7 min', icon:'💰' },
  { slug:'bujurg-char-dham-yatra', title:'बुजुर्ग माँ-बाप को चार धाम यात्रा करानी है? — यह 12 बातें पहले जान लें', excerpt:'60-80 साल के बुजुर्ग भी कर सकते हैं चार धाम। घोड़ा, पालकी, हेलिकॉप्टर — Senior Special Package ₹21,000 से।', tag:'हिंदी गाइड', readTime:'7 min', icon:'👴' },
