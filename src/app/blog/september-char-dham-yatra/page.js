...
const FAQS = [
  ...
  { q:'Is the Kedarnath trek open in September?', a:'Yes, the trek, ponies and palkis run right through September and October until the temple closes in November, and helicopters do fly more reliably after the monsoon because visibility improves. One timing caveat this season: Kedarnath heli services have been grounded since 1 July for the monsoon and are being prepared to resume on 15 September, subject to a DGCA inspection in the first week of the month. If your dates fall in the first fortnight of September, plan on the trek, pony or palki and treat the helicopter as a bonus if the restart holds.' },
];
