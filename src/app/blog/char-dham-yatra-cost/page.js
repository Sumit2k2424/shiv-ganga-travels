      ...
      <article className="blog-container" itemScope itemType="https://schema.org/Article">
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13.5 }}>
            ...
            <tbody>
              {[
                ...
                ['Senior Special 12N/13D','₹21,000','Private AC, ground floor priority','Ground floor preferred','Breakfast + dinner + pony at Yamunotri'],
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 24 }}>
          {[
            ...
            { item:'🛕 Palki/Doli — one way up', cost:KEDARNATH_TREK.palki.up, detail:`Four bearers carry you in a palanquin. The Zila Panchayat's 2026 board prices it by the passenger's weight: ${KEDARNATH_TREK.palki.explained}, the bearers waiting at the top. Best for pilgrims who cannot walk any distance. Book at the prepaid counter, not operators on the trail.` },
