...
export default function Page() {
  ...
  return (
    <GuideArticle
      ...
      readTime="5 min read"
      takeaways={[
        <>The Uttarakhand four are the <strong>Chota Char Dham</strong>; the original spans the whole country (Badrinath, Dwarka, Puri, Rameswaram).</>,
        <>The circuit is traditionally credited to <strong>Adi Shankaracharya</strong> in the 8th century.</>,
        <>It honours the source rivers (<strong>Yamuna, Ganga</strong>) and two great deities (<strong>Shiva, Vishnu</strong>).</>,
        <>Pilgrims walk it <strong>clockwise, west to east</strong> — devotionally a parikrama, practically the cleanest road order from Haridwar.</>,
      ]}
      toc={[
        { id:'bigger-char-dham',   label:'The two Char Dhams' },
        { id:'shankaracharya',     label:'Adi Shankaracharya' },
        { id:'what-each-honours',  label:'What each dham honours' },
    ...
    >
      ...
      <H2 id="bigger-char-dham">The bigger Char Dham, and the Himalayan one</H2>
      ...
      <H2 id="shankaracharya">Adi Shankaracharya and the revival</H2>
      ...
      <H2 id="what-each-honours">What each dham actually honours</H2>
      <UL items={[
      ...
      <H2 id="fixed-order">Why the order is fixed</H2>
      ...
      <H2 id="why-it-pulls">Why it still pulls people up the mountain</H2>
