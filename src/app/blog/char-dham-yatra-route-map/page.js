...
function Schema() {
  const article = {
    ...
    '@type': 'Article',
    headline: 'Char Dham Yatra Route Map 2026 – Complete Road Guide from Haridwar with Distances',
    description: '',
    ...
    mainEntityOfPage: `${SITE.baseUrl}/blog/char-dham-yatra-route-map`,
  };
    ...
    <>
      ...
      <article style={{ maxWidth: 900, margin: '0 auto', padding: '40px 20px 60px' }}>
        ...
        <div style={{ fontSize: 12, color: 'var(--text-muted)', marginBottom: 20, textAlign: 'right' }}>
          🗓️ <strong>Last updated:</strong> May 21, 2026 · ✍️ <strong>By:</strong> Shiv Ganga Travels, Haridwar (15 seasons on this route)
        </div>
