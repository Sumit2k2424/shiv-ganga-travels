...
export default function HaridwarToKedarnath() {
  return (<>
    ...
    <article className="blog-container" itemScope itemType="https://schema.org/Article">
      ...
      <BlogTOC items={[
        { id:'total-distance', label:'Total distance' },
        { id:'day-by-day',     label:'Day-by-day breakdown' },
        { id:'road-map',       label:'Road map' },
        { id:'key-stops',      label:'Key stops along the route' },
        { id:'all-options',    label:'All options compared' },
        { id:'taxi-fare',      label:'Taxi fare by vehicle' },
        { id:'faq',            label:'FAQs' },
      ]}/>
      ...
      <h2 id="key-stops" style={h2}>Key Stops Along the Route</h2>
