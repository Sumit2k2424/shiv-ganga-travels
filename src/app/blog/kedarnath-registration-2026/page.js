...
function Schema() {
  const faq = {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'Is the Kedarnath e-pass different from yatra registration?', acceptedAnswer: { '@type': 'Answer', text: 'No — the e-pass, the Uttarakhand travel pass and the yatra registration are the same document: the QR-coded Yatra Registration Letter generated at registrationandtouristcare.uk.gov.in. One pass covers all the dhams you select in a single tour entry, including a combined Badrinath-Kedarnath trip. It is free.' } },
      { '@type': 'Question', name: 'What is badrinath-kedarnath.gov.in used for?', acceptedAnswer: { '@type': 'Answer', text: 'badrinath-kedarnath.gov.in is the official BKTC (Badri Kedar Temple Committee) website, used for temple puja bookings, donations and announcements. Yatra registration does NOT happen there — that is done only at registrationandtouristcare.uk.gov.in, the Uttarakhand Tourism portal.' } },
    ],
  };
  const bc = {
