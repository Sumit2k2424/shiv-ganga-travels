...
function Schema() {
  const article = {
    ...
    '@type': 'Article',
    headline: 'Kedarnath Yatra Registration 2026 – Online Process, Documents & WhatsApp Registration',
    description: '',
    ...
    mainEntityOfPage: `${SITE.baseUrl}/blog/kedarnath-registration-2026`,
  };
