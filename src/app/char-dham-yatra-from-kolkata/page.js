...
export const metadata = {
  title: 'Char Dham Yatra from Kolkata 2026 — Train, Flight & Package from ₹24,999',
  description: 'Char Dham Yatra from Kolkata 2026. 1,500 km by train (20 hrs), 2h by flight. Trains, flights, pickups explained. All-inclusive packages from ₹24,999. Direct Haridwar operator since 2010.',
  keywords: ['char dham yatra from kolkata','char dham yatra package from kolkata','kolkata to haridwar char dham','char dham tour from kolkata 2026','chardham yatra kolkata','kolkata char dham yatra package'],
  alternates: { canonical: `${SITE.baseUrl}/char-dham-yatra-from-kolkata` },
  openGraph: {
    title: 'Char Dham Yatra from Kolkata 2026 — Trains, Flights & Packages from ₹24,999',
    description: '1,500 km by train (20 hrs), 2h by flight. Char Dham packages from ₹24,999/person. Zero commission, direct Haridwar operator.',
    url: `${SITE.baseUrl}/char-dham-yatra-from-kolkata`, type:'website',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Char Dham Yatra 2026 from Kolkata — Shiv Ganga Travels' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Char Dham Yatra from Kolkata 2026 — Trains, Flights & Packages from ₹2',
    description: '1,500 km by train (20 hrs), 2h by flight. Char Dham packages from ₹24,999/person. Zero commission, direct Haridwar operator.',
    images: [{ url: '/opengraph-image', alt: 'Char Dham Yatra 2026 from Kolkata — Shiv Ganga Travels' }],
  },
};
...
function Schema() {
  const faq = {
    ...
    mainEntity:[
      { '@type':'Question', name:'How to reach Haridwar from Kolkata for Char Dham Yatra?', acceptedAnswer:{ '@type':'Answer', text:'Kolkata (CCU) to Dehradun — no direct flight; via Delhi (1h 50m flight + 5.5h Shatabdi or 1.5h taxi). Or fly CCU to Delhi (₹3,000–5,500) and connect to Haridwar. Total: 8–10 hrs door to door.' } },
      { '@type':'Question', name:'What is the Char Dham Yatra package cost from Kolkata?', acceptedAnswer:{ '@type':'Answer', text:'Char Dham Yatra from Kolkata starts at ₹24,999/person for a 9N/10D all-inclusive package — AC vehicle, hotels, meals, VIP darshan at all 4 dhams, guide, registration. Zero commission.' } },
      { '@type':'Question', name:'How many days for Char Dham Yatra from Kolkata?', acceptedAnswer:{ '@type':'Answer', text:'Plan 11–13 days from Kolkata: 1 day travel to Haridwar + 9–10 days Char Dham circuit + 1–2 days return.' } },
    ],
  };
  const bc = {
    ...
    itemListElement:[
      ...
      { '@type':'ListItem', position:3, name:'From Kolkata', item:`${SITE.baseUrl}/char-dham-yatra-from-kolkata` },
    ],
  };
    ...
    <>
      ...
      <section style={{ background:'linear-gradient(145deg,var(--navy) 0%,#1A3E75 60%,var(--teal) 100%)', padding:'52px 20px 40px', textAlign:'center' }}>
        <div style={{ maxWidth:860, margin:'0 auto' }}>
          <span style={{ background:'rgba(232,146,10,0.18)', color:'#FFD166', fontSize:11, fontWeight:700, letterSpacing:'0.12em', textTransform:'uppercase', padding:'5px 16px', borderRadius:100, display:'inline-block', marginBottom:14 }}>
            Kolkata · Char Dham 2026 · Direct Operator
          </span>
          ...
          <p style={{ color:'rgba(255,255,255,0.85)', fontSize:15, lineHeight:1.7, maxWidth:680, margin:'0 auto 20px' }}>
            1,500 km by train (20 hrs), 2h by flight · All-inclusive from <strong style={{ color:'#FFD166' }}>{ '₹24,999' }/person</strong> · Zero commission
          </p>
          ...
          <div style={{ display:'flex', gap:12, justifyContent:'center', flexWrap:'wrap' }}>
            <a href={`https://wa.me/${SITE.whatsapp}?text=${encodeURIComponent('Namaste! I want to book Char Dham Yatra 2026 from Kolkata.')}`} target="_blank" rel="nofollow noopener noreferrer"
      ...
      <article style={{ maxWidth:900, margin:'0 auto', padding:'40px 20px 60px' }}>
        ...
        <div style={{ background:'var(--navy)', borderRadius:14, padding:'18px 20px', marginBottom:28, display:'grid', gridTemplateColumns:'repeat(auto-fill,minmax(140px,1fr))', gap:10 }}>
          {[['Distance','1500 km'],['Best route','Fly to Dehradun/Delhi'],['Total trip','11–13 days'],['Package from','₹24,999/person'],['Season 2026','Apr 19 – Nov'],['Registration','FREE · We handle']].map(([k,v])=>(
        ...
        <p style={p}><strong>Char Dham Yatra from Kolkata 2026:</strong> The distance from Kolkata to Haridwar is approximately 1500km. Kolkata (CCU) to Dehradun — no direct flight; via Delhi (1h 50m flight + 5.5h Shatabdi or 1.5h taxi). Or fly CCU to Delhi (₹3,000–5,500) and connect to Haridwar. Total: 8–10 hrs door to door. Our all-inclusive 9N/10D package from Kolkata is ₹24,999/person — covers the full circuit with AC vehicle, hotels, meals, VIP darshan, and guide. Everything on this page is specific to Kolkata pilgrims.</p>

        <h2 style={h2}>How to Reach Haridwar from Kolkata</h2>
        <p style={p}>All our packages start from Haridwar. Getting there from Kolkata is your first step. Actual train names, timings and costs below:</p>
        ...
        <div style={{ overflowX:'auto', marginBottom:20 }}>
          <table style={{ width:'100%', borderCollapse:'collapse', fontSize:13 }}>
            ...
            <tbody>
              {[
                ['Doon Express (13009)','Howrah','07:10 PM','Haridwar','02:30 PM (+1)','19h 20m','Only direct Kolkata–Haridwar train'],
                ['Amritsar Mail (13005)','Howrah','06:30 PM','Haridwar','05:20 AM (+1)','~23h','Slower but budget option'],
        ...
        <div style={{ background:'#EEF6FF', border:'1px solid #B5D4F4', borderRadius:10, padding:'12px 16px', marginBottom:20 }}>
          ...
          <div style={{ fontSize:13.5, color:'#185FA5', lineHeight:1.7 }}>Kolkata (CCU) to Dehradun — no direct flight; via Delhi (1h 50m flight + 5.5h Shatabdi or 1.5h taxi). Or fly CCU to Delhi (₹3,000–5,500) and connect to Haridwar. Total: 8–10 hrs door to door.</div>
        </div>
        ...
        <div style={{ background:'#fff', borderRadius:10, padding:'14px 16px', border:'1px solid var(--border)', borderLeft:'3px solid var(--teal)', marginBottom:20 }}>
          <div style={{ fontWeight:700, fontSize:13.5, color:'var(--navy)', marginBottom:6 }}>🚗 By Road from Kolkata</div>
          <div style={{ fontSize:13.5, color:'#475569', lineHeight:1.7 }}>The Doon Express from Howrah is the only direct train to Haridwar — a 19-hour overnight journey that many Kolkata pilgrims prefer as a pilgrimage in itself. Book in 3AC or SL 60+ days ahead.</div>
        </div>
        ...
        <div style={{ background:'rgba(232,146,10,0.07)', border:'1px solid rgba(232,146,10,0.25)', borderRadius:10, padding:'14px 16px', marginBottom:28 }}>
          <div style={{ fontWeight:700, fontSize:13, color:'#7B3F00', marginBottom:4 }}>💡 What we know about Kolkata pilgrims (15 years of experience)</div>
          <div style={{ fontSize:13.5, color:'#7B3F00', lineHeight:1.7 }}>West Bengal has an enormous yatra tradition — many Bengali pilgrims combine Char Dham with a Vaishno Devi or Badrinath visit. The Doon Express is almost always full from Howrah in May and September.</div>
        </div>

        <h2 style={h2}>What's Included — Kolkata Char Dham Package</h2>
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))', gap:8, marginBottom:24 }}>
          {['✅ AC vehicle (Innova / Tempo Traveller)','✅ Station or airport pickup in Kolkata or Haridwar','✅ Hotel accommodation all 9 nights (twin sharing)','✅ Breakfast + dinner every day','✅ VIP darshan — no queue at all 4 dhams','✅ Experienced Garhwali guide throughout','✅ Biometric registration handled — completely free','✅ All tolls, parking, driver allowance included','✅ Oxygen cylinder + first aid kit on vehicle','✅ 24hr WhatsApp support during the entire yatra'].map(item=>(
        ...
        <div style={{ background:'rgba(29,158,117,0.08)', border:'1px solid #1D9E75', borderRadius:10, padding:'12px 16px', marginBottom:24, fontSize:13.5, color:'#0F5132' }}>
          <strong>Package from Kolkata:</strong> ₹24,999/person · 9N/10D · All-inclusive · 5% GST included · Zero commission — you pay us directly
        </div>

        <h2 style={h2}>Our Pickup Points in Kolkata</h2>
        <p style={p}>We pick up from these Kolkata locations. If you are at a different address, WhatsApp us — we accommodate almost all requests.</p>
        <div style={{ display:'flex', gap:8, flexWrap:'wrap', marginBottom:28 }}>
          ...
          <span key='Kolkata Airport T1/T2' style={{ background:'#fff',border:'1px solid var(--border)',color:'var(--navy)',padding:'7px 14px',borderRadius:8,fontSize:12.5,fontWeight:600 }}>📍 Kolkata Airport T1/T2</span>
        ...
        <div style={{ background:'var(--navy)', borderRadius:16, padding:'28px 24px', textAlign:'center', marginTop:32 }}>
          <div style={{ color:'#FFD166', fontSize:13, fontWeight:700, marginBottom:6 }}>🙏 Kolkata → Haridwar → Char Dham</div>
          <h3 style={{ color:'#fff', fontFamily:'var(--font-display)', fontSize:'1.3rem', marginBottom:8 }}>Book Your Char Dham Yatra from Kolkata</h3>
