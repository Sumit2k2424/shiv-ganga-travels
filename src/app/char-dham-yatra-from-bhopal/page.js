...
export const metadata = {
  title: { absolute: `Char Dham Yatra from Bhopal ${SITE.season} | Road & Train Options` },
  description: `Char Dham Yatra from Bhopal ${SITE.season} — 900km by road (14–15 hrs) or train. Trusted operator, 15+ yrs experience, fixed departures & instant confirmation.`,
  keywords: ['char dham yatra from bhopal','char dham yatra package from bhopal','bhopal to haridwar char dham',`char dham tour from bhopal ${SITE.season}`,'chardham yatra bhopal','bhopal char dham yatra package'],
  alternates: { canonical: `${SITE.baseUrl}/char-dham-yatra-from-bhopal` },
  openGraph: {
    title: `Char Dham Yatra from Bhopal ${SITE.season} — Trains, Flights & Packages from ₹23,999`,
    ...
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: `Char Dham Yatra ${SITE.season} from Bhopal — Shiv Ganga Travels` }],
  },
  twitter: {
    card: 'summary_large_image',
    title: `Char Dham Yatra from Bhopal ${SITE.season}`,
    description: '900 km by road (14–15 hrs) or train. Char Dham packages from ₹23,999/person. Zero commission, direct Haridwar operator.',
    images: [{ url: '/opengraph-image', alt: `Char Dham Yatra ${SITE.season} from Bhopal — Shiv Ganga Travels` }],
  },
};
...
const PAA = [
  { q:'How far is Char Dham Yatra from Bhopal?', a:'Bhopal to Haridwar — the gateway to the dhams — is roughly 900 km. The full Char Dham circuit then covers about 1,100–1,400 km from Haridwar and back.' },
  { q:'How do I reach Haridwar from Bhopal?', a:'From Bhopal it\'s about 900 km to Haridwar. Best options: road (14–15 hrs), train, or fly via Delhi. Jolly Grant Airport, Dehradun is the nearest airport (35 km from Haridwar); Haridwar Junction is the nearest railhead. From there the circuit begins.' },
  { q:'How many days are needed for Char Dham Yatra from Bhopal?', a:'Plan 10–12 days for the full road circuit including travel from Bhopal. By helicopter (flying from Dehradun) the on-ground portion drops to 5–6 days. Senior citizens should allow a couple of extra days for acclimatisation.' },
  { q:'What is the cost of Char Dham Yatra from Bhopal?', a:'Our all-inclusive road packages start from ₹23,999 per person, covering vehicle from Haridwar, hotels, meals, guide, VIP darshan and free registration. The helicopter package runs about ₹2.2–2.4 lakh. Train or flight fare to Haridwar/Dehradun is usually separate.' },
  { q:'What is the best time for Char Dham Yatra from Bhopal?', a:'May–June and September–October, matching the temple season — the 2026 dhams open between April 19 and 23. Book early for these peak windows and avoid the July–August monsoon, when landslides can delay the mountain stretches.' },
    ...
    <>
      ...
      <article style={{ maxWidth:900, margin:'0 auto', padding:'40px 20px 60px' }}>
        ...
        <div style={{ display:'flex', gap:8, flexWrap:'wrap', marginBottom:28 }}>
          <span key='Bhopal Junction Station' style={{ background:'#fff',border:'1px solid hsl(var(--border))',color:'var(--navy)',padding:'7px 14px',borderRadius:8,fontSize:12.5,fontWeight:600 }}>📍 Bhopal Junction Station</span>
          <span key='Raja Bhoj Airport' style={{ background:'#fff',border:'1px solid hsl(var(--border))',color:'var(--navy)',padding:'7px 14px',borderRadius:8,fontSize:12.5,fontWeight:600 }}>📍 Raja Bhoj Airport</span>
          <span key='DB City Mall area' style={{ background:'#fff',border:'1px solid hsl(var(--border))',color:'var(--navy)',padding:'7px 14px',borderRadius:8,fontSize:12.5,fontWeight:600 }}>📍 DB City Mall area</span>
        </div>
