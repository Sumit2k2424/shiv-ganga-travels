    ...
    <article style={{ maxWidth:820, margin:'0 auto', padding:'32px 20px 60px' }}>
      ...
      <div style={{ background:'var(--navy-light)', borderRadius:14, padding:'18px 20px', marginBottom:24, marginTop:28 }}>
        ...
        <div style={{ display:'flex', flexWrap:'wrap', gap:8 }}>
          {[{l:'Gangotri Yatra Package',h:'/gangotri-yatra'},{l:'Gangotri Temple Guide',h:'/gangotri-temple'},{l:'How to Reach Gangotri',h:'/how-to-reach-gangotri'},{l:'Haridwar to Gangotri Cab',h:'/cabs'},{l:'Char Dham Road Status',h:'/char-dham-road-status'},{l:'Do Dham Yatra',h:'/do-dham-yatra'},{l:'Teen Dham Yatra',h:'/teen-dham-yatra'},].map(l=>(
      ...
      <div style={{ background:'var(--navy)', borderRadius:16, padding:'26px 24px', textAlign:'center' }}>
        ...
        <p style={{ color:'rgba(255,255,255,0.75)', fontSize:13.5, marginBottom:18 }}>Built into our Gangotri &amp; Char Dham itineraries &middot; Direct Haridwar operator</p>
