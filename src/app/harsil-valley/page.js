...
export const metadata = {
  title: 'Harsil Valley Guide 2026 — Permits, Weather & Route',
    ...
    <article style={{ maxWidth:820, margin:'0 auto', padding:'32px 20px 60px' }}>
      ...
      <div style={{ background:'var(--navy-light)', borderRadius:14, padding:'18px 20px', marginBottom:24, marginTop:28 }}>
        ...
        <div style={{ display:'flex', flexWrap:'wrap', gap:8 }}>
          {[{l:'Gangotri Yatra Package',h:'/gangotri-yatra'},{l:'Gangotri Temple Guide',h:'/gangotri-temple'},{l:'How to Reach Gangotri',h:'/how-to-reach-gangotri'},{l:'Haridwar to Gangotri Cab',h:'/haridwar-to-gangotri-cab'},{l:'Char Dham Road Status',h:'/char-dham-road-status'},{l:'Do Dham Yatra',h:'/do-dham-yatra'}].map(l=>(
