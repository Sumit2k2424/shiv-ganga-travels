...
export const metadata = {
  title: { absolute: `चार धाम यात्रा ${SITE.season} | ₹13,900 से | पूरी जानकारी हिन्दी में` },
  description: `चार धाम यात्रा ${SITE.season} — हरिद्वार से 9 रात/10 दिन ₹13,900 से। सीधे ऑपरेटर, कोई एजेंट कमीशन नहीं, रजिस्ट्रेशन मुफ़्त। खर्च, तारीखें और रास्ता।`,
  // Cost queries deliberately excluded — /blog/char-dham-yatra-kitna-kharcha
  // already owns `चार धाम यात्रा ${SITE.season} खर्चा` and the per-person cost terms.
  // This page takes the broad head term; that blog keeps the cost long-tail.
  keywords: [
    'चार धाम यात्रा', `चार धाम यात्रा ${SITE.season}`, 'चार धाम यात्रा कितने दिन की है',
  ...
  openGraph: {
    ...
    type: 'website',
    locale: 'hi_IN',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: `Char Dham Yatra ${SITE.season} in Hindi — Shiv Ganga Travels` }],
  },
  twitter: {
    card: 'summary_large_image',
    title: `चार धाम यात्रा ${SITE.season} — पूरी जानकारी हिन्दी में`,
    description: 'हरिद्वार से ₹13,900 से। सीधे ऑपरेटर, कोई एजेंट कमीशन नहीं।',
    images: [{ url: '/opengraph-image', alt: `चार धाम यात्रा ${SITE.season} | Shiv Ganga Travels` }],
  },
};
