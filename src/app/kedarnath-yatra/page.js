...
function Schema() {
  ...
  return (<><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(bc) }}/><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context':'https://schema.org','@type':'WebPage','@id':`${SITE.baseUrl}/kedarnath-yatra#webpage`, url:`${SITE.baseUrl}/kedarnath-yatra`, name:'Kedarnath Yatra 2026 Guide & Packages', inLanguage:'en-IN', speakable:{ '@type':'SpeakableSpecification', cssSelector:['.speakable-answer'] } }) }}/></>);
}
    ...
    <>
      ...
      <section style={{ background: 'linear-gradient(145deg,var(--navy) 0%,#1A3E75 60%,var(--teal) 100%)', padding: '56px 20px 44px', textAlign: 'center' }}>
        <div style={{ maxWidth: 820, margin: '0 auto' }}>
          ...
          <h1 className="display-title speakable-answer" style={{ color: '#fff', fontSize: 'clamp(1.8rem,4.5vw,3rem)', marginBottom: 16 }}>Kedarnath Yatra Package 2026 — Trek, Pony &amp; Helicopter</h1>
          <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: 15, lineHeight: 1.7 }}>Lord Shiva's highest Himalayan abode · 16km trek from Gaurikund<br/>Packages from <strong style={{ color: '#FFD166' }}>₹5,250</strong> · Pony · Helicopter · VIP Darshan</p>
      ...
      <article style={{ maxWidth: 900, margin: '0 auto', padding: '40px 20px 60px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(260px,1fr))', gap: 12, marginBottom: 28 }}>
          {[
            ...
            { name:'Guptkashi', dist:'210km', desc:'Your overnight base before the trek. Guptkashi has its own Vishwanath Temple — where Shiva hid (gupt = hidden) from the Pandavas before being found at Kedarnath. The ridge road above town has Himalayan views that match Kedarnath itself. Most pilgrims rush through — don\'t.' },
            ...
            { name:'Gaurikund', dist:'235km', desc:'Named after Goddess Gauri (Parvati), who bathed here while awaiting Shiva. The natural hot spring kund (48°C year-round) is right at the trek start. Pilgrims take a ritual dip before climbing. The masala chai at the trail-mouth shops, at 2,000m, is genuinely excellent.' },
          ].map(pl => (
        ...
        <div style={{ background: 'var(--navy)', borderRadius: 16, padding: '28px 24px', textAlign: 'center', marginTop: 32 }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: 14, marginBottom: 20 }}>Zero commission. Registration handled. Free itinerary in 2 hours. ₹5,250/person all-inclusive.</p>
