...
const FAQS = [
  { q:'How much does the Char Dham Yatra cost per person in 2026?', a:'Per person, a road-based Char Dham Yatra from Haridwar costs roughly ₹18,500–₹28,000 on a budget tier, ₹28,000–₹40,000 deluxe, and ₹45,000–₹65,000 luxury. A full helicopter charter runs ₹2.09–2.5 lakh; ours is ₹2,30,000. The exact figure depends on group size, season, start city and add-ons like pony or VIP darshan — which is what this calculator estimates.' },
