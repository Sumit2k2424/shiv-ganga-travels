...
const TIERS = {
  budget:    { label:'Budget',    sub:'Guesthouses · shared Tempo', nights:'9N/10D',  lo:13900, hi:28000 },
  deluxe:    { label:'Deluxe',    sub:'2–3★ hotels · Innova',       nights:'11N/12D', lo:28000, hi:40000 },
  luxury:    { label:'Luxury',    sub:'Premium hotels · private',   nights:'11N/12D', lo:30000, hi:65000 },
...
const FAQS = [
  { q:'How much does the Char Dham Yatra cost per person in 2026?', a:'Per person, a road-based Char Dham Yatra from Haridwar costs roughly ₹13,900–₹28,000 on a budget tier, ₹28,000–₹40,000 deluxe, and ₹30,000–₹65,000 luxury. A full helicopter charter runs ₹2.09–2.5 lakh; ours is ₹2,30,000. The exact figure depends on group size, season, start city and add-ons like pony or VIP darshan — which is what this calculator estimates.' },
