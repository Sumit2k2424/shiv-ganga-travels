...
export const metadata = {
  title: { absolute: `Char Dham Yatra from Delhi ${SITE.season} | Price Starts at ₹17,200 | Train & Flight Pickup` },
  ...
  openGraph: {
    title: `Char Dham Yatra from Delhi ${SITE.season} — Trains, Flights & Packages from ₹17,200`,
    ...
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: `Char Dham Yatra ${SITE.season} from Delhi — Shiv Ganga Travels` }],
  },
  twitter: {
    card: 'summary_large_image',
    title: `Char Dham Yatra from Delhi ${SITE.season} — Trains, Flights & Packages from ₹17,200`,
    description: '250–335 km depending on pickup point. Char Dham packages from ₹17,200/person. Zero commission, direct Haridwar operator.',
    images: [{ url: '/opengraph-image', alt: `Char Dham Yatra ${SITE.season} from Delhi — Shiv Ganga Travels` }],
  },
};
    ...
    <>
      ...
      <article style={{ maxWidth:900, margin:'0 auto', padding:'40px 20px 60px' }}>
        ...
        <div style={{ display:'flex', gap:8, flexWrap:'wrap', marginBottom:28 }}>
          <span key='Connaught Place' style={{ background:'#fff',border:'1px solid hsl(var(--border))',color:'var(--navy)',padding:'7px 14px',borderRadius:8,fontSize:12.5,fontWeight:600 }}>📍 Connaught Place</span>
          <span key='Nizamuddin Station' style={{ background:'#fff',border:'1px solid hsl(var(--border))',color:'var(--navy)',padding:'7px 14px',borderRadius:8,fontSize:12.5,fontWeight:600 }}>📍 Nizamuddin Station</span>
          <span key='Kashmere Gate ISBT' style={{ background:'#fff',border:'1px solid hsl(var(--border))',color:'var(--navy)',padding:'7px 14px',borderRadius:8,fontSize:12.5,fontWeight:600 }}>📍 Kashmere Gate ISBT</span>
          <span key='Anand Vihar ISBT' style={{ background:'#fff',border:'1px solid hsl(var(--border))',color:'var(--navy)',padding:'7px 14px',borderRadius:8,fontSize:12.5,fontWeight:600 }}>📍 Anand Vihar ISBT</span>
          <span key='Noida Sector 18' style={{ background:'#fff',border:'1px solid hsl(var(--border))',color:'var(--navy)',padding:'7px 14px',borderRadius:8,fontSize:12.5,fontWeight:600 }}>📍 Noida Sector 18</span>
          <span key='Gurugram Cyber Hub' style={{ background:'#fff',border:'1px solid hsl(var(--border))',color:'var(--navy)',padding:'7px 14px',borderRadius:8,fontSize:12.5,fontWeight:600 }}>📍 Gurugram Cyber Hub</span>
        </div>
