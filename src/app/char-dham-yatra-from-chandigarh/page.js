...
const PAA = [
  { q:'How far is Char Dham Yatra from Chandigarh?', a:'Chandigarh to Haridwar — the gateway to the dhams — is roughly 290 km. The full Char Dham circuit then covers about 1,100–1,400 km from Haridwar and back.' },
  { q:'How do I reach Haridwar from Chandigarh?', a:'From Chandigarh it\'s about 290 km to Haridwar. Best options: 5h by road or 4h by train — the closest major city. Jolly Grant Airport, Dehradun is the nearest airport (35 km from Haridwar); Haridwar Junction is the nearest railhead. From there the circuit begins.' },
  { q:'How many days are needed for Char Dham Yatra from Chandigarh?', a:'Plan 9–11 days for the full road circuit including travel from Chandigarh. By helicopter (flying from Dehradun) the on-ground portion drops to 5–6 days. Senior citizens should allow a couple of extra days for acclimatisation.' },
  { q:'What is the cost of Char Dham Yatra from Chandigarh?', a:'Our all-inclusive road packages start from ₹21,499 per person, covering vehicle from Haridwar, hotels, meals, guide, VIP darshan and free registration. The helicopter package runs about ₹2.2–2.4 lakh. Train or flight fare to Haridwar/Dehradun is usually separate.' },
  { q:'What is the best time for Char Dham Yatra from Chandigarh?', a:'May–June and September–October, matching the temple season — the 2026 dhams open between April 19 and 23. Book early for these peak windows and avoid the July–August monsoon, when landslides can delay the mountain stretches.' },
...
<span key="Chandigarh Railway Station" style={{ background:'#fff', border:'1px solid hsl(var(--border))', color:'var(--navy)', padding:'7px 14px', borderRadius:8, fontSize:12.5, fontWeight:600 }}>📍 {`Chandigarh Railway Station`}</span>
        ...
        <BlogCTA variant="footer" intent="booking" />
          ...
          <PeopleAlsoAsk items={PAA}/>
              ...
              <CityLinkMesh current="chandigarh" />
      </article>
    </>
  );
}
