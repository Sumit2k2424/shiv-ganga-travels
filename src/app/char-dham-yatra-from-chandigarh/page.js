...
export const metadata = {
  title: 'Char Dham Yatra from Chandigarh 2026 — Train, Flight & Package from ₹22,999',
  description: 'Char Dham Yatra from Chandigarh 2026. 215 km by road (4–4.5 hrs) via NH7. Trains, flights, pickups explained. All-inclusive packages from ₹22,999. Direct Haridwar operator since 2010.',
  keywords: ['char dham yatra from chandigarh','char dham yatra package from chandigarh','chandigarh to haridwar char dham','char dham tour from chandigarh 2026','chardham yatra chandigarh','chandigarh char dham yatra package'],
...
function Schema() {
  const faq = {
    ...
    mainEntity:[
      { '@type':'Question', name:'How to reach Haridwar from Chandigarh for Char Dham Yatra?', acceptedAnswer:{ '@type':'Answer', text:'Chandigarh to Dehradun is 4 hours by road — much faster than flying. Chandigarh has no direct flight to Dehradun. Road or train is the clear winner.' } },
      { '@type':'Question', name:'What is the Char Dham Yatra package cost from Chandigarh?', acceptedAnswer:{ '@type':'Answer', text:'Char Dham Yatra from Chandigarh starts at ₹22,999/person for a 9N/10D all-inclusive package — AC vehicle, hotels, meals, VIP darshan at all 4 dhams, guide, registration. Zero commission.' } },
      { '@type':'Question', name:'How many days for Char Dham Yatra from Chandigarh?', acceptedAnswer:{ '@type':'Answer', text:'Plan 11–13 days from Chandigarh: 1 day travel to Haridwar + 9–10 days Char Dham circuit + 1–2 days return.' } },
    ],
  };
  const bc = {
    ...
    itemListElement:[
      ...
      { '@type':'ListItem', position:3, name:'From Chandigarh', item:`${SITE.baseUrl}/char-dham-yatra-from-chandigarh` },
    ],
  };
    ...
    <>
      ...
      <section style={{ background:'linear-gradient(145deg,var(--navy) 0%,#1A3E75 60%,var(--teal) 100%)', padding:'52px 20px 40px', textAlign:'center' }}>
        <div style={{ maxWidth:860, margin:'0 auto' }}>
          <span style={{ background:'rgba(232,146,10,0.18)', color:'#FFD166', fontSize:11, fontWeight:700, letterSpacing:'0.12em', textTransform:'uppercase', padding:'5px 16px', borderRadius:100, display:'inline-block', marginBottom:14 }}>
            Chandigarh · Char Dham 2026 · Direct Operator
          </span>
          ...
          <div style={{ display:'flex', gap:12, justifyContent:'center', flexWrap:'wrap' }}>
            <a href={`https://wa.me/${SITE.whatsapp}?text=${encodeURIComponent('Namaste! I want to book Char Dham Yatra 2026 from Chandigarh.')}`} target="_blank" rel="nofollow noopener noreferrer"
      ...
      <article style={{ maxWidth:900, margin:'0 auto', padding:'40px 20px 60px' }}>
        ...
        <div style={{ background:'var(--navy)', borderRadius:14, padding:'18px 20px', marginBottom:28, display:'grid', gridTemplateColumns:'repeat(auto-fill,minmax(140px,1fr))', gap:10 }}>
          {[['Distance','215 km'],['Best route','Road or direct train'],['Total trip','11–13 days'],['Package from','₹22,999/person'],['Season 2026','Apr 19 – Nov'],['Registration','FREE · We handle']].map(([k,v])=>(
        ...
        <p style={p}><strong>Char Dham Yatra from Chandigarh 2026:</strong> The distance from Chandigarh to Haridwar is approximately 215km. Chandigarh to Dehradun is 4 hours by road — much faster than flying. Chandigarh has no direct flight to Dehradun. Road or train is the clear winner. Our all-inclusive 9N/10D package from Chandigarh is ₹22,999/person — covers the full circuit with AC vehicle, hotels, meals, VIP darshan, and guide. Everything on this page is specific to Chandigarh pilgrims.</p>

        <h2 style={h2}>How to Reach Haridwar from Chandigarh</h2>
        <p style={p}>All our packages start from Haridwar. Getting there from Chandigarh is your first step. Actual train names, timings and costs below:</p>
        ...
        <div style={{ overflowX:'auto', marginBottom:20 }}>
          <table style={{ width:'100%', borderCollapse:'collapse', fontSize:13 }}>
            ...
            <tbody>
              {[
                ['Chandigarh–Haridwar Intercity (14631)','Chandigarh','05:25 AM','Haridwar','09:50 AM','4h 25m','Best option — fast and convenient'],
                ['Nanda Devi Express via Amb Andaura','Chandigarh','Morning','Haridwar','~5h','₹150–₹500',''],
        ...
        <div style={{ background:'#EEF6FF', border:'1px solid #B5D4F4', borderRadius:10, padding:'12px 16px', marginBottom:20 }}>
          ...
          <div style={{ fontSize:13.5, color:'#185FA5', lineHeight:1.7 }}>Chandigarh to Dehradun is 4 hours by road — much faster than flying. Chandigarh has no direct flight to Dehradun. Road or train is the clear winner.</div>
        </div>
        ...
        <div style={{ background:'#fff', borderRadius:10, padding:'14px 16px', border:'1px solid var(--border)', borderLeft:'3px solid var(--teal)', marginBottom:20 }}>
          <div style={{ fontWeight:700, fontSize:13.5, color:'var(--navy)', marginBottom:6 }}>🚗 By Road from Chandigarh</div>
          <div style={{ fontSize:13.5, color:'#475569', lineHeight:1.7 }}>Chandigarh is the closest major city to Haridwar after Delhi. Leave by 6 AM, reach Haridwar by 10 AM, spend the morning at Har Ki Pauri, and start the Char Dham circuit the next day from Haridwar. Quickest pre-yatra day of any city.</div>
        </div>
        ...
        <div style={{ background:'rgba(232,146,10,0.07)', border:'1px solid rgba(232,146,10,0.25)', borderRadius:10, padding:'14px 16px', marginBottom:28 }}>
          <div style={{ fontWeight:700, fontSize:13, color:'#7B3F00', marginBottom:4 }}>💡 What we know about Chandigarh pilgrims (15 years of experience)</div>
          <div style={{ fontSize:13.5, color:'#7B3F00', lineHeight:1.7 }}>Chandigarh, Mohali, and Panchkula have strong pilgrimage demand — particularly from Punjabi Hindu families and retired government officers. Many Chandigarh pilgrims combine Char Dham with a Hemkund Sahib Gurudwara visit.</div>
        </div>

        <h2 style={h2}>What's Included — Chandigarh Char Dham Package</h2>
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))', gap:8, marginBottom:24 }}>
          {['✅ AC vehicle (Innova / Tempo Traveller)','✅ Station or airport pickup in Chandigarh or Haridwar','✅ Hotel accommodation all 9 nights (twin sharing)','✅ Breakfast + dinner every day','✅ VIP darshan — no queue at all 4 dhams','✅ Experienced Garhwali guide throughout','✅ Biometric registration handled — completely free','✅ All tolls, parking, driver allowance included','✅ Oxygen cylinder + first aid kit on vehicle','✅ 24hr WhatsApp support during the entire yatra'].map(item=>(
        ...
        <div style={{ background:'rgba(29,158,117,0.08)', border:'1px solid #1D9E75', borderRadius:10, padding:'12px 16px', marginBottom:24, fontSize:13.5, color:'#0F5132' }}>
          <strong>Package from Chandigarh:</strong> ₹22,999/person · 9N/10D · All-inclusive · 5% GST included · Zero commission — you pay us directly
        </div>

        <h2 style={h2}>Our Pickup Points in Chandigarh</h2>
        <p style={p}>We pick up from these Chandigarh locations. If you are at a different address, WhatsApp us — we accommodate almost all requests.</p>
        <div style={{ display:'flex', gap:8, flexWrap:'wrap', marginBottom:28 }}>
          ...
          <span key='ISBT Bus Stand' style={{ background:'#fff',border:'1px solid var(--border)',color:'var(--navy)',padding:'7px 14px',borderRadius:8,fontSize:12.5,fontWeight:600 }}>📍 ISBT Bus Stand</span>
          <span key='Sector 17 Plaza' style={{ background:'#fff',border:'1px solid var(--border)',color:'var(--navy)',padding:'7px 14px',borderRadius:8,fontSize:12.5,fontWeight:600 }}>📍 Sector 17 Plaza</span>
          <span key='Mohali Airport' style={{ background:'#fff',border:'1px solid var(--border)',color:'var(--navy)',padding:'7px 14px',borderRadius:8,fontSize:12.5,fontWeight:600 }}>📍 Mohali Airport</span>
        </div>
        ...
        <div style={{ background:'var(--navy)', borderRadius:16, padding:'28px 24px', textAlign:'center', marginTop:32 }}>
          <div style={{ color:'#FFD166', fontSize:13, fontWeight:700, marginBottom:6 }}>🙏 Chandigarh → Haridwar → Char Dham</div>
          <h3 style={{ color:'#fff', fontFamily:'var(--font-display)', fontSize:'1.3rem', marginBottom:8 }}>Book Your Char Dham Yatra from Chandigarh</h3>
