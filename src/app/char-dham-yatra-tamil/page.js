...
export const metadata = {
  title: { absolute: `சார் தாம் யாத்திரை ${SITE.season} | ₹13,900 முதல் | தமிழில்` },
  ...
  openGraph: {
    ...
    type: 'website',
    locale: 'ta_IN',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: `Char Dham Yatra ${SITE.season} in Tamil — Shiv Ganga Travels` }],
  },
};
