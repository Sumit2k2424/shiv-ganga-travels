...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: `How to Reach Badrinath ${SITE.season} — Road Route & Complete Guide | Shiv Ganga Travels` }],
  },
  twitter: {
      ...
      <article style={{ maxWidth:900, margin:'0 auto', padding:'40px 20px 60px' }}>
        ...
        <div style={{ borderTop:'1px solid hsl(var(--border))', paddingTop:24, marginTop:32 }}>
          ...
          <div style={{ display:'flex', gap:10, flexWrap:'wrap' }}>
            {[['How to Reach Kedarnath','/blog/how-to-reach-kedarnath'],['Badrinath Weather','/badrinath-weather'],['Badrinath Temple Guide','/badrinath-temple'],['Badrinath VIP Darshan','/badrinath-vip-darshan'],['Haridwar to Badrinath Cab','/cabs/haridwar-to-badrinath-cab'],['Char Dham Route Map','/char-dham-yatra-route-map']].map(([l,h]) => (
