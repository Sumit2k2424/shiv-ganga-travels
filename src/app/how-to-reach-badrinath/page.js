      ...
      <article style={{ maxWidth:900, margin:'0 auto', padding:'40px 20px 60px' }}>
        ...
        <div style={{ borderTop:'1px solid hsl(var(--border))', paddingTop:24, marginTop:32 }}>
          ...
          <div style={{ display:'flex', gap:10, flexWrap:'wrap' }}>
            {[['How to Reach Kedarnath','/blog/how-to-reach-kedarnath'],['Badrinath Weather','/badrinath-weather'],['Badrinath Temple Guide','/badrinath-temple'],['Haridwar to Badrinath Cab','/cabs'],['Char Dham Route Map','/char-dham-yatra-route-map']].map(([l,h]) => (
