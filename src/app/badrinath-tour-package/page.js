...
export const metadata = {
  ...
  openGraph: {
    title: `Badrinath Tour Package ${SITE.season} | Hotels & Transport Included`,
    description:
      `No trek to the temple. Customizable itinerary, Mana village & Tapt Kund, ${SITE.season} registration help. Direct Haridwar operator since 2010 with 15+ years experience · ${SITE.reviews.rating}★ from ${SITE.reviews.count} reviews.`,
  ...
  twitter: {
    ...
    title: `Badrinath Tour Package ${SITE.season}`,
    description: 'Badrinath 2N/3D from Haridwar, no trek. Trusted operator, fixed departures, instant confirmation. ₹0 to enquire.',
  ...
  return (
    <>
      ...
      <article style={{ maxWidth: 860, margin: '0 auto', padding: '8px 20px 56px' }}>
        ...
        <h3 style={h3}>Badrinath at night — why the overnight stay is the point</h3>
        <p style={p}>Day-trippers never see the version of Badrinath that stays with you. After the evening Shayan Aarti (usually 8:30–9 PM), the crowds drain away, the temple facade glows against a black sky, and the only sounds are the Alaknanda and the temple bells. Nights are cold even in June — carry a proper jacket — and the town runs on generator schedules, so the stars above Neelkanth are the brightest most plains-dwellers have ever seen. This is precisely why our package sleeps both nights at Badrinath rather than retreating down to Joshimath: you get the night temple, and you are 200 metres from the gate for the 4:30 AM Maha Abhishek instead of an hour&apos;s drive away. On a pilgrimage this old — a Vishnu kshetra sung by the Alvars and re-established by Adi Shankaracharya — the quiet hours are the ones that do the work.</p>
