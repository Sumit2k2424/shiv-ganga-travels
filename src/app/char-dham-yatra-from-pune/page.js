...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Char Dham Yatra 2026 from Pune — Shiv Ganga Travels' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Char Dham Yatra from Pune 2026 — Trains, Flights & Packages from ₹24,9',
    description: '1,600 km — fly via Mumbai or Delhi. Char Dham packages from ₹24,999/person. Zero commission, direct Haridwar operator.',
    images: [{ url: '/opengraph-image', alt: 'Char Dham Yatra 2026 from Pune — Shiv Ganga Travels' }],
  },
};
