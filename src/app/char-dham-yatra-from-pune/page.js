...
export const metadata = {
  title: { absolute: 'Char Dham Yatra from Pune 2026 | Price Starts at ₹24,999 | Pickup & VIP Darshan' },
  description: 'Char Dham Yatra from Pune 2026 — 1,360km, Pune–Dehradun train or fly + train. Trusted operator, 15+ yrs experience, fixed departures & instant confirmation.',
  ...
  openGraph: {
    title: 'Char Dham Yatra from Pune 2026 — Direct Operator, Zero Commission',
    description: 'Char Dham Yatra from Pune 2026. 1,360 km · Pune–Dehradun train (30h) · or fly Delhi + train. All-inclusive packages from ₹24,999/person. Direct Haridwar operator — zero commission. Pune pickup, VIP da',
    url: `${SITE.baseUrl}/char-dham-yatra-from-pune`,
    type: 'website',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Char Dham Yatra from Pune 2026 — Shiv Ganga Travels' }],
  },
};
...
function Schema() {
  const org = {
    ...
    areaServed: [{ '@type':'City', name:'Pune' }, { '@type':'State', name:'Uttarakhand' }],
  };
  const faq = {
    '@context': 'https://schema.org', '@type': 'FAQPage',
    mainEntity: [
      { '@type':'Question', name:'How to reach Haridwar from Pune for Char Dham Yatra?', acceptedAnswer:{ '@type':'Answer', text:'Pune to Haridwar — Pune–Dehradun Express (19029) is a direct train, ~30 hours. Or fly to Delhi (1.5h) and take the Mussoorie Express overnight. Either option works well.' } },
      { '@type':'Question', name:'What is the cost of Char Dham Yatra from Pune?', acceptedAnswer:{ '@type':'Answer', text:'Char Dham Yatra from Pune with Shiv Ganga Travels starts at ₹24,999/person for a 9N/10D all-inclusive package from Haridwar. This covers AC vehicle, hotels, breakfast and dinner, VIP darshan at all 4 dhams, and 24x7 support. Pune pickup is available.' } },
    ],
  };
    ...
    <>
      ...
      <section style={{ background:'linear-gradient(145deg,var(--navy) 0%,#1A3E75 60%,var(--teal) 100%)', padding:'52px 20px 40px' }}>
        <div style={{ maxWidth:860, margin:'0 auto', textAlign:'center' }}>
          <span style={{ background:'rgba(232,146,10,0.18)', color:'#FFD166', fontSize:11, fontWeight:700, letterSpacing:'0.12em', textTransform:'uppercase', padding:'5px 16px', borderRadius:100, display:'inline-block', marginBottom:14 }}>Char Dham Yatra 2026 · From Pune</span>
          ...
          <p style={{ color:'rgba(255,255,255,0.8)', fontSize:15, lineHeight:1.7, maxWidth:700, margin:'0 auto 20px' }}>
            1,360 km · Pune–Dehradun train (30h) · or fly Delhi + train · All-inclusive from <strong style={{ color:'#FFD166' }}>₹24,999/person</strong> · Zero commission
          </p>
          <div style={{ display:'flex', gap:10, justifyContent:'center', flexWrap:'wrap' }}>
            <a href={`https://wa.me/${SITE.whatsapp}?text=${encodeURIComponent('Namaste! I want to book Char Dham Yatra 2026 from Pune. Please share packages and availability.')}`} target="_blank" rel="nofollow noopener noreferrer"
      ...
      <article style={{ maxWidth:900, margin:'0 auto', padding:'36px 20px 60px' }}>
        ...
        <div style={{ background:'var(--navy)', borderRadius:14, padding:'18px 20px', marginBottom:28, display:'grid', gridTemplateColumns:'repeat(auto-fill,minmax(140px,1fr))', gap:10 }}>
          <div key="Distance"><div style={{ fontSize:11, color:'rgba(255,255,255,0.55)', marginBottom:2 }}>{`Distance`}</div><div style={{ fontWeight:700, fontSize:13.5, color:'#FFD166' }}>{`1,360 km`}</div></div>
          <div key="Pune–Dehradun train"><div style={{ fontSize:11, color:'rgba(255,255,255,0.55)', marginBottom:2 }}>{`Pune–Dehradun train`}</div><div style={{ fontWeight:700, fontSize:13.5, color:'#FFD166' }}>{`~30h direct`}</div></div>
          <div key="Fly Delhi + train"><div style={{ fontSize:11, color:'rgba(255,255,255,0.55)', marginBottom:2 }}>{`Fly Delhi + train`}</div><div style={{ fontWeight:700, fontSize:13.5, color:'#FFD166' }}>{`8–10h total`}</div></div>
        ...
        <p style={{ ...p, fontStyle:'italic', borderLeft:'3px solid var(--teal)', paddingLeft:16, background:'var(--navy-light)', padding:'14px 16px', borderRadius:'0 10px 10px 0', marginBottom:24 }}>
          <strong>Pune to Haridwar — Char Dham 2026:</strong> Pune has a direct train option — the Pune–Dehradun Express. 30 hours in 3AC and you arrive at Haridwar in the morning. Or fly to Delhi (1.5 hours) and catch the overnight Mussoorie Express. Both work.
        </p>
        ...
        <h3 style={{ fontFamily:'var(--font-display)', fontSize:'1.05rem', fontWeight:700, color:'var(--navy)', marginBottom:10, marginTop:20 }}>🚂 Train from Pune</h3>
        ...
        <div style={{ background:'rgba(232,146,10,0.07)', border:'1px solid rgba(232,146,10,0.25)', borderRadius:10, padding:'14px 16px', marginBottom:28 }}>
          <div style={{ fontWeight:700, fontSize:13, color:'#7B3F00', marginBottom:4 }}>💡 What we know about Pune pilgrims — 15 seasons of experience</div>
          <div style={{ fontSize:13.5, color:'#7B3F00', lineHeight:1.75 }}>Pune sends a steady and loyal contingent. Maratha families from the Peth areas see Char Dham as a natural extension of their Pandharpur and Jejuri pilgrim tradition. Several Pune families have booked with us three or more consecutive years. The post-Gudi Padwa window — late March and April — sees booking spikes from Pune even before the season opens. Maharashtrian pilgrims plan the yatra as a new year spiritual journey. Book by February if you want a May departure.</div>
        </div>

        <BlogCTA variant="inline" intent="booking" />

        <h2 style={{...h2}}>Package Inclusions — Char Dham from Pune</h2>
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))', gap:8, marginBottom:16 }}>
          {[
            '✅ AC vehicle (Innova / Tempo Traveller)',
            '✅ Airport / station pickup in Pune or Haridwar',
