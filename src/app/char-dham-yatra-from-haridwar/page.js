  ...
  return (
    <>
      ...
      <article style={{ maxWidth:900, margin:'0 auto', padding:'32px 20px 60px' }}>
        ...
        <p style={p}><strong>By air:</strong> Jolly Grant Airport, Dehradun (DED) is 35 km away — about 1 hour by road. <strong>By train:</strong> Haridwar Junction is well connected to Delhi, Lucknow, Kolkata and Mumbai. <strong>By road:</strong> NH-334 from Delhi via Meerut and Roorkee, roughly 5.5 hours. <strong>By helicopter:</strong> the Char Dham heli yatra itself departs from Sahastradhara Helipad in Dehradun — we arrange transfers from Haridwar. If you are coming from a specific city, see our pickup pages for <Link href="/char-dham-yatra-from-delhi" style={{ color:'var(--teal)', fontWeight:600 }}>Delhi</Link>, <Link href="/char-dham-yatra-from-rishikesh" style={{ color:'var(--teal)', fontWeight:600 }}>Rishikesh</Link> and 20+ other cities.</p>
