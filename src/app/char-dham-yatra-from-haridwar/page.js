...
export const metadata = {
  ...
  openGraph: {
    title: `Char Dham Yatra from Haridwar ${SITE.season} — Itinerary, Cost & Packages from ₹20,999`,
    description: `Everything for the Char Dham Yatra starting from Haridwar — day-by-day itinerary, cost breakdown, mandatory ${SITE.season} registration, route map and helicopter options. Direct Haridwar operator since 2010.`,
    url: `${SITE.baseUrl}/char-dham-yatra-from-haridwar`, type:'website',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: `Char Dham Yatra ${SITE.season} from Haridwar — Shiv Ganga Travels` }],
  },
  twitter: {
    card: 'summary_large_image',
    title: `Char Dham Yatra from Haridwar ${SITE.season} — Packages from ₹20,999`,
    description: 'Itinerary, cost, registration, route map & helicopter options. Direct Haridwar operator, zero commission.',
    images: [{ url: '/opengraph-image', alt: `Char Dham Yatra ${SITE.season} from Haridwar — Shiv Ganga Travels` }],
  },
};
...
const FAQS = [
  ...
  { q:'How much does a Char Dham package from Haridwar cost in 2026?', a:'Our Char Dham Yatra from Haridwar starts at ₹20,999 per person for a 9N/10D all-inclusive road package — AC Tempo Traveller or Innova, hotels on twin sharing, daily breakfast and dinner, an experienced Garhwali guide, VIP darshan at all four dhams, and free biometric registration. Deluxe 11N/12D runs ₹30,000 and the 5N/6D helicopter charter is ₹2,30,000. Prices are direct — no agent commission.' },
  ...
  { q:'Should I choose the road or helicopter Char Dham package?', a:'Choose road if you have 10–12 days, want the traditional immersive journey, and prefer a budget from ₹20,999. Choose helicopter if you are short on time or travelling with elderly pilgrims — it completes all four dhams in 5–6 days with VIP darshan, at ₹2,30,000 from Dehradun. Road departs directly from Haridwar; the helicopter yatra starts at Sahastradhara Helipad in Dehradun, 35 km away.' },
];
      ...
      <article style={{ maxWidth:900, margin:'0 auto', padding:'32px 20px 60px' }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(240px,1fr))', gap:12, marginBottom:24 }}>
          {[
            ...
            ['Char Dham 11N/12D — Deluxe','₹30,000','Relaxed pace · 3-star hotels · Innova Crysta','/packages/char-dham-yatra-11n-12d-haridwar'],
            ['Senior Citizen 12N/13D','₹21,000','Extra rest day · pony/palki · ground-floor rooms','/packages/char-dham-yatra-senior-citizen-12n-13d'],
