...
const FAQS = [
  ...
  { q:'How much does a Char Dham package from Haridwar cost in 2026?', a:'Our Char Dham Yatra from Haridwar starts at ₹20,999 per person for a 9N/10D all-inclusive road package — AC Tempo Traveller or Innova, hotels on twin sharing, daily breakfast and dinner, an experienced Garhwali guide, VIP darshan at all four dhams, and free biometric registration. Deluxe 11N/12D runs ₹33,800 and the 5N/6D helicopter charter is ₹2,30,000. Prices are direct — no agent commission.' },
      ...
      <article style={{ maxWidth:900, margin:'0 auto', padding:'32px 20px 60px' }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(240px,1fr))', gap:12, marginBottom:24 }}>
          {[
            ...
            ['Char Dham 11N/12D — Deluxe','₹33,800','Relaxed pace · 3-star hotels · Innova Crysta','/packages/char-dham-yatra-11n-12d-haridwar'],
