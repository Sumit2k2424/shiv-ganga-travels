...
import {
  getDestination, getDestinationParams, isDestinationPublishable, robotsFor,
...
export async function generateMetadata({ params }) {
  ...
  const desc = `Book a cab to ${d.name} from ${routes.map(routeFrom).join(', ')}. Fares from ${cheapest}, fixed all-inclusive. Road ends at ${d.lastMotorable}. Haridwar operator.`;
