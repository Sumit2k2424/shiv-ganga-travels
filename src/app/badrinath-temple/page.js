    ...
    <article style={{ maxWidth:900, margin:'0 auto', padding:'40px 20px 60px' }}>
      ...
      <figure style={{ margin:'0 0 20px', borderRadius:14, overflow:'hidden', border:'1px solid hsl(var(--border))' }}>
        ...
        <figcaption style={{ padding:'10px 14px', fontSize:12.5, color:'#64748b', background:'#F8FAFC', lineHeight:1.6 }}>
          Sunirmal Ji and his wife, who travelled with us, on the forecourt below the Singh Dwar, the temple&apos;s painted main gate. This is as far as you need to walk: the road ends a few hundred metres away, and the steps behind them climb through the gate to the sanctum. Even in mid-September those steps were busy on this Saturday, so aim for a weekday if you can. {BADRINATH_PILGRIMS_PHOTO.credit}
        </figcaption>
      </figure>
      ...
      <div style={{ background:'var(--navy)', borderRadius:16, padding:'26px 24px', textAlign:'center' }}>
        ...
        <p style={{ color:'rgba(255,255,255,0.75)', fontSize:13.5, marginBottom:18 }}>Maha Abhishek booking included · VIP darshan · From ₹4,500</p>
