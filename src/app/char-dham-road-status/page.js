...
const MONSOON_NOTE = `Monsoon update (${UPDATED}): the yatra is running normally — there has been no state-wide halt since the two-day administrative pause of July 28–29, and on August 11 the state confirmed the pilgrimage was continuing smoothly through the rains. The current weather picture is a fresh IMD Dehradun warning issued August 14 that runs through August 17. The useful detail for pilgrims is where the orange alert actually sits: August 16 covers Dehradun, Champawat, Bageshwar, Udham Singh Nagar and Nainital, and August 17 covers Dehradun, Pauri and Tehri. The core Garhwal yatra districts — Uttarkashi, Chamoli and Rudraprayag — are on the lighter yellow alert this weekend rather than orange, which is a better run than the first fortnight of August gave us. The State Emergency Operations Centre has directed that trekking not be permitted while it is actually raining, so expect the Kedarnath trek from Gaurikund to be held at the barrier during a downpour and released when it eases. The last confirmed highway blockages were on August 6, when debris cut the Badrinath highway near Helang (Chamoli), the Gangotri highway (NH-34) near Dharasu Nalu Pani, and the Yamunotri highway (NH-134) near Silai Bend and at Syanachatti — all cleared the same day. Keep a buffer day and expect blockages that open within hours rather than days. Note that Kedarnath helicopter services have been suspended since July 1 for the monsoon under DGCA guidance, with operators back at base; no resumption date has been announced and the realistic window is post-monsoon September — pony, palki and the trek are the ways up until then. Night driving on Char Dham routes is banned between 10 PM and 4 AM, and passenger vehicles need a valid Green Card to ply hill routes. On footfall: Kedarnath and Badrinath alone have now taken 30,62,228 pilgrims this season (16,12,112 at Kedarnath, 14,50,116 at Badrinath, as of August 11), and Char Dham registrations have crossed 50 lakh. Confirm conditions on the morning you travel — our drivers report road status daily, or check the official links below.`;
...
const PAA = [
  { q:'Is the Char Dham road open today?', a:`As of ${UPDATED}, yes — all four routes (Yamunotri, Gangotri, Kedarnath up to Gaurikund, and Badrinath) are open, and there has been no state-wide suspension since the two-day administrative pause of July 28–29. On August 11 the state confirmed the yatra was running smoothly through the monsoon. What you should expect instead is single-point blockages that clear within hours: on August 6, debris cut the Badrinath highway near Helang in Chamoli, the Gangotri highway near Dharasu Nalu Pani, and the Yamunotri highway near Silai Bend and at Syanachatti, and crews reopened all three. The live weather picture is an IMD warning issued August 14 and running to August 17 — orange alert on Dehradun, Champawat, Bageshwar, Udham Singh Nagar and Nainital on August 16, and Dehradun, Pauri and Tehri on August 17, with Uttarkashi, Chamoli and Rudraprayag on yellow. The State Emergency Operations Centre has directed that trekking not be permitted while rain is actually falling, so a Kedarnath trek start can be held at the barrier during a downpour. Kedarnath helicopter services have been suspended since July 1 for the monsoon under DGCA guidance. Confirm on the day with UTDB or the police helpline (112 / 1070) before you set off.` },
  ...
  return (<>
    ...
    <article style={{ maxWidth:900, margin:'0 auto', padding:'34px 20px 60px' }}>
      ...
      <p style={{ ...p, fontSize:16.5, background:'var(--navy-light)', borderRadius:12, padding:'16px 18px' }}>
        <strong>Short answer:</strong> as of {UPDATED}, all four Char Dham routes are open and motorable — Yamunotri, Gangotri, Kedarnath (road runs to Gaurikund, then a 16 km trek) and Badrinath (drive to the gate) — and the yatra has run without a state-wide halt since the two-day pause of July 28–29. The monsoon is still the thing to plan around: an IMD warning issued August 14 runs through August 17, though this spell puts the orange alert mostly on Dehradun, Kumaon and the plains districts and leaves Uttarkashi, Chamoli and Rudraprayag on yellow. The last confirmed highway blockages were on August 6, when single points on the Badrinath, Gangotri and Yamunotri highways were cut by debris and cleared the same day. Treat the table below as the season picture, not a live feed, and confirm status on the morning you drive using the <a href="#live" style={{ color:'var(--teal)', fontWeight:600 }}>official sources here</a>.
      </p>
