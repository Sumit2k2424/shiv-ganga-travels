...
const MONSOON_NOTE = `Monsoon update (${UPDATED}): the yatra resumed at 6 AM today across all four routes, after the administration paused it for two days (July 28–29) once fresh landslides hit the Chamoli–Rudraprayag stretch under heavy rain. The Badrinath highway was blocked near Bhanerpani (Pipalkoti, Chamoli district), and the Pokhari–Rudraprayag link road was blocked near Guniyala Khal by fallen rock and debris; NDRF/SDRF teams and highway crews cleared both before the restart. Minor blockages and short delays are still likely as rain continues, and the same Munkatiya point near Sonprayag on the Kedarnath route (blocked and cleared on July 12) remains one to watch. Kedarnath helicopter services keep getting suspended whenever visibility drops and winds pick up. Night driving on Char Dham routes is banned between 10 PM and 4 AM, and passenger vehicles need a valid Green Card to ply hill routes. Despite the disruptions, over 45 lakh pilgrims (4,523,412, as of July 25) have completed the yatra this season. Confirm conditions on the morning you travel — our drivers report road status daily, or check the official links below.`;
...
const ROUTES = [
  { dham:'Yamunotri', via:'NH-134, Dharasu → Barkot → Janki Chatti', status:'Open · reopened after a 2-day halt', tone:'caution',
    note:'The slowest-progressing route under the all-weather project (~57% widened). Expect narrow single-lane patches between Dharasu Bend and Janki Chatti, plus the most frequent monsoon landslide closures of the four. The last 5–6 km from Janki Chatti to the temple is a steep trek or pony/palki. Like the other three dhams, this route was part of the administration\'s two-day yatra-wide pause (July 28–29) and reopened on the morning of July 30.' },
  { dham:'Gangotri', via:'NH-34, Uttarkashi → Harsil → Gangotri', status:'Open · reopened after a 2-day halt', tone:'caution',
    note:'Largely motorable right up to the temple. The Uttarkashi–Gangotri stretch is scenic but has a handful of chronic slide spots near Gangnani and Sungar that get cleared quickly. Snow can briefly shut the road in early and late season. Like the other three dhams, this route was part of the administration\'s two-day yatra-wide pause (July 28–29) and reopened on the morning of July 30.' },
  { dham:'Kedarnath', via:'NH-109, Rudraprayag → Sonprayag → Gaurikund', status:'Open to Gaurikund · then 16 km trek', tone:'caution',
    note:'The road end is Sonprayag; from there a shuttle runs to Gaurikund, and the 16–18 km trek (or pony/palki/helicopter) begins. The Fata–Sitapur section is now about 99% widened, so the drive up is far smoother than it used to be. Current watch (July 2026): this route was part of the administration\'s two-day yatra-wide pause (July 28–29), triggered partly by a blockage on the nearby Pokhari–Rudraprayag link road near Guniyala Khal; it reopened on the morning of July 30. The Munkatiya point near Sonprayag remains one to watch — a landslide blocked it on July 12 and was cleared the same day by JCBs. Helicopter services from the Kedarnath sector get suspended whenever visibility drops.' },
  { dham:'Badrinath', via:'NH-58, Joshimath → Govindghat → Badrinath', status:'Open · reopened after a 2-day halt', tone:'caution',
    note:'You can drive to the temple gate — no trek. The one stretch to respect is the gated section around Joshimath–Badrinath, where the army/BRO regulate one-way traffic through narrow cuttings. Current watch (July 2026): the highway was blocked near Bhanerpani (Pipalkoti, Chamoli) on July 28–29, part of a two-day yatra-wide pause that lifted on the morning of July 30; Patalganga and Tangni remain the recurring boulder-fall points during heavy rain. Time your run with the gate timings and check the morning status.' },
];
...
const PAA = [
  { q:'Is the Char Dham road open today?', a:`As of ${UPDATED}, yes — all four routes (Yamunotri, Gangotri, Kedarnath up to Gaurikund, and Badrinath) reopened at 6 AM today after the administration paused the whole yatra for two days (July 28–29) once heavy rain triggered fresh landslides, including a blockage on the Badrinath highway near Bhanerpani (Pipalkoti, Chamoli) and on the Pokhari–Rudraprayag link road near Guniyala Khal. The monsoon is still active, so short, rain-triggered closures remain likely — the Kedarnath highway at Munkatiya near Sonprayag was blocked and cleared on July 12, and that stretch stays one to watch. Kedarnath helicopter services pause when visibility drops. Confirm on the day with UTDB or the police helpline (112 / 1070) before you set off.` },
