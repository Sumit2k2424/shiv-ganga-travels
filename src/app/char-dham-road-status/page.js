...
const MONSOON_NOTE = `Kedarnath trek update (${UPDATED}): the Kedarnath walking route is the one part of the circuit not running normally. Rockfall near the Chirbasa helipad, on the trek between Gaurikund and Kedarnath, began on the morning of September 11 and damaged part of the path; after more rain on the night of September 11 the route was blocked again on September 12 and the Rudraprayag District Disaster Management Officer, Nandan Singh Rajwar, halted pilgrim movement at Sonprayag and Gaurikund as a precaution. On September 14 the SDRF post at Sonprayag, with police and DDRF, moved more than 6,500 pilgrims and around 600–700 horses and mules off the affected stretch, with the police saying the slope was still too active to clear while rain and stones kept coming; by the evening the rockfall had eased and remaining pilgrims were being walked down from Bhimbali to Gaurikund one at a time under escort. On September 15 the trek was reported closed for a third consecutive day. Horse, mule and dandi-kandi services on the route have been halted since the first rockfall. Helicopter services to Kedarnath have resumed after the monsoon suspension, and IRCTC HeliYatra opened bookings on September 14 at 2 PM for travel between September 15 and 30 — so the shrine is reachable by air while the path is shut, but sectors are limited and weather-dependent. The road itself is open to Sonprayag, and open on all four routes; we have found no reported highway blockage on the Badrinath, Gangotri or Yamunotri routes since August 6, though the Alaknanda and Mandakini ran near warning level in Rudraprayag in the first week of September and IMD kept Uttarkashi, Rudraprayag and Chamoli under orange alert on September 3–4. If your Kedarnath leg falls in the next few days, plan for a hold at Sonprayag, or swap the trek for a helicopter sector if you can book one; if it falls later, keep the buffer day. Night driving on Char Dham routes remains banned between 10 PM and 4 AM and hill-route vehicles still need a valid Green Card. Confirm the morning you travel — our drivers report daily, or use the official links below.`;

// Dated bulletins from the field & official advisories (most recent first)
const LATEST_UPDATES = [
  { date:'Sep 15, 2026', text:'The Kedarnath trek route was reported closed for a third consecutive day because of continuing rockfall near Chirbasa, with several hundred pilgrims still on the route being brought down under escort. Helicopter services to Kedarnath have resumed after the monsoon suspension: IRCTC HeliYatra opened bookings on September 14 at 2 PM for travel from September 15 to 30, on the Sirsi, Phata and Guptkashi sectors. Char Dham registration remains mandatory for a heli ticket. The road to Sonprayag is open; the closure is the footpath above Gaurikund.' },
  { date:'Sep 14, 2026', text:'More than 6,500 pilgrims and around 600–700 horses and mules were moved off the damaged stretch near the Chirbasa helipad by the SDRF post at Sonprayag (Sub-Inspector Ashish Dimri, under Commandant Arpan Yaduvanshi) working with police, DDRF and the district administration. Rudraprayag Police said the route could not be cleared while rain and stones kept falling; pilgrims were held at Sonprayag, Gaurikund and Jungle Chatti. Heavy rain had the Alaknanda and Mandakini running high. By evening the District Disaster Management Officer reported the rockfall had subsided and pilgrims were being escorted from Bhimbali down to Gaurikund one by one.' },
...
const ROUTES = [
  { dham:'Yamunotri', via:'NH-134, Dharasu → Barkot → Janki Chatti', status:'Open · no blockage reported since Aug 6', tone:'caution',
    note:'The slowest-progressing route under the all-weather project (~57% widened). Expect narrow single-lane patches between Dharasu Bend and Janki Chatti, plus the most frequent monsoon landslide closures of the four. The last 5–6 km from Janki Chatti to the temple is a steep trek or pony/palki. Current watch (September 15, 2026): no blockage reported since August 6, when NH-134 was blocked twice — near Silai Bend in the Durbil area after continuous rockfall, and near Silaiband at Syanachatti under debris — with NHAI crews clearing both. This is the route where a rain day is most likely to cost you hours, so build the buffer here.' },
  { dham:'Gangotri', via:'NH-34, Uttarkashi → Harsil → Gangotri', status:'Open · no blockage reported since Aug 6', tone:'caution',
    note:'Largely motorable right up to the temple. The Uttarkashi–Gangotri stretch is scenic but has a handful of chronic slide spots near Gangnani and Sungar that get cleared quickly. Snow can briefly shut the road in early and late season. Current watch (September 15, 2026): no blockage reported since August 6, when NH-34 was blocked near Dharasu Nalu Pani and reopened near Papdagad for small vehicles first, with heavy vehicles restored after — the usual sequence here, so a car gets through well before a bus does.' },
  { dham:'Kedarnath', via:'NH-109, Rudraprayag → Sonprayag → Gaurikund', status:'Road open to Sonprayag · trek CLOSED at Chirbasa since Sep 12 · heli running', tone:'caution',
    note:'The road end is Sonprayag; from there a shuttle runs to Gaurikund, and the 16–18 km trek (or pony/palki) begins. The Fata–Sitapur section is now about 99% widened, so the drive up is far smoother than it used to be. Current watch (September 15, 2026): the road is fine — no highway blockage reported since August 6 — but the trek above Gaurikund is shut. Rockfall near the Chirbasa helipad on September 11 damaged the path, the route was closed on September 12, and on September 14 more than 6,500 pilgrims and 600–700 pack animals were evacuated by SDRF; as of September 15 it was closed for a third day, with horse, mule and dandi-kandi services halted. Helicopter services have resumed and IRCTC bookings for September 15–30 opened on September 14. If you are due here this week, expect to be held at Sonprayag until the administration declares the path safe, or book a heli sector. The Munkatiya point near Sonprayag and the standing rule that trekking stops while rain is falling both still apply.' },
  { dham:'Badrinath', via:'NH-58, Joshimath → Govindghat → Badrinath', status:'Open · no blockage reported since Aug 6', tone:'caution',
    note:'You can drive to the temple gate — no trek. The one stretch to respect is the gated section around Joshimath–Badrinath, where the army/BRO regulate one-way traffic through narrow cuttings. Current watch (September 15, 2026): no blockage reported since August 6, when the highway was blocked near Helang (Chamoli) when debris and loose rock came down, and the district administration asked people to avoid the stretch until it was declared safe; BRO, NHAI and PWD crews cleared it. Helang, Patalganga, Tangni, Lambagad and Pipalkoti are the recurring boulder-fall points during heavy rain. Time your run with the gate timings and check the morning status.' },
];
...
const PAA = [
  { q:'Is the Char Dham road open today?', a:`As of ${UPDATED}, the roads are open on all four routes — Yamunotri, Gangotri, Kedarnath to Sonprayag, and Badrinath to the temple gate — and there has been no state-wide suspension since the two-day pause of July 28–29. What is not open is the Kedarnath trek above Gaurikund: rockfall near the Chirbasa helipad on September 11 damaged the path, the administration closed it on September 12, more than 6,500 pilgrims were evacuated on September 14, and on September 15 it was shut for a third day with pony, mule and dandi-kandi services halted. Helicopter services to Kedarnath have resumed, with IRCTC bookings for September 15–30 open since September 14. The last highway blockages we can confirm on the other three routes were on August 6 and were cleared the same day. Check the morning you travel.` },
  ...
  return (<>
    ...
    <article style={{ maxWidth:900, margin:'0 auto', padding:'34px 20px 60px' }}>
      ...
      <p style={{ ...p, fontSize:16.5, background:'var(--navy-light)', borderRadius:12, padding:'16px 18px' }}>
        <strong>Short answer:</strong> as of {UPDATED}, the roads are open on all four routes — Yamunotri, Gangotri, Kedarnath (to Sonprayag) and Badrinath (to the gate) — but the Kedarnath trek is closed. Rockfall near the Chirbasa helipad damaged the path on September 11; the route was shut on September 12, more than 6,500 pilgrims and 600–700 pack animals were evacuated on September 14, and on September 15 it stayed closed for a third day. Helicopter services have resumed and IRCTC opened bookings for September 15–30 on September 14, so Kedarnath is reachable by air. No highway blockage has been reported on the other routes since August 6. Plan a Sonprayag hold if your Kedarnath leg is this week.
      </p>
