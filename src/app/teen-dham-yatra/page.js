      ...
      <article style={{ maxWidth: 900, margin: '0 auto', padding: '40px 20px 60px' }}>
        ...
        <div style={{ borderTop: '1px solid hsl(var(--border))', paddingTop: 24, marginTop: 32 }}>
          ...
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginBottom: 20 }}>
            {[['Yamunotri Yatra', '/yamunotri-yatra'], ['Yamunotri Temple', '/yamunotri-temple'], ['How to Reach Yamunotri', '/how-to-reach-yamunotri'], ['Gangotri Yatra', '/gangotri-yatra'], ['Gangotri Temple', '/gangotri-temple'], ['How to Reach Gangotri', '/how-to-reach-gangotri'], ['Badrinath Yatra', '/badrinath-yatra'], ['Badrinath Temple', '/badrinath-temple'], ['How to Reach Badrinath', '/how-to-reach-badrinath'], ['Harsil Valley', '/harsil-valley'], ['Mana Village', '/blog/mana-village-badrinath']].map(([l, href]) => (
