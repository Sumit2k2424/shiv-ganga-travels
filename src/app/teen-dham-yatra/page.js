    ...
    <>
      ...
      <article style={{ maxWidth: 900, margin: '0 auto', padding: '40px 20px 60px' }}>
        ...
        <div style={{ borderTop: '1px solid hsl(var(--border))', paddingTop: 24, marginTop: 32 }}>
          ...
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginBottom: 20 }}>
            {[['Char Dham Yatra', '/char-dham-yatra'], ['Do Dham Yatra', '/do-dham-yatra'], ['Kedarnath Yatra', '/kedarnath-yatra'], ['Panch Kedar Yatra', '/panch-kedar-yatra'], ['Panch Badri Yatra', '/panch-badri-yatra'], ['Char Dham by Helicopter', '/char-dham-helicopter'], ['All Packages', '/packages'], ['Char Dham from Haridwar', '/char-dham-yatra-from-haridwar'], ['Char Dham from Delhi', '/char-dham-yatra-from-delhi'], ['Winter Char Dham', '/winter-char-dham-yatra'], ['Do Dham vs Char Dham', '/blog/char-dham-vs-do-dham'], ['Types of Packages', '/blog/types-of-char-dham-yatra-packages']].map(([l, href]) => (
              <Link key={href} href={href} style={{ background: 'var(--bg)', border: '1px solid hsl(var(--border))', color: 'var(--navy)', padding: '7px 14px', borderRadius: 8, fontSize: 12.5, fontWeight: 600, textDecoration: 'none' }}>{l} →</Link>
            ))}
          </div>
