  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(citableDataset({
        ...
        description: 'Month-by-month temperature, snow, rainfall and best-visit verdicts for Gangotri (3,415m), recorded on the route by Shiv Ganga Travels.',
        path: '/gangotri-weather',
        modified: '2026-08-22',
      ...
      <div style={{ maxWidth:900, margin:'0 auto', padding:'40px 20px 60px' }}>
        ...
        <div style={{ borderTop:'1px solid hsl(var(--border))', paddingTop:24, marginTop:32 }}>
          ...
          <div style={{ display:'flex', gap:10, flexWrap:'wrap' }}>
            {[['How to Reach Gangotri','/how-to-reach-gangotri'],['Yamunotri Weather','/yamunotri-weather'],['Badrinath Weather','/badrinath-weather'],['Best Time to Visit','/blog/best-time-char-dham'],['Gangotri Yatra','/gangotri-yatra']].map(([l,h]) => (
