...
export const metadata = {
  ...
  description: 'Char Dham Yatra from Mumbai 2026. Flight to Dehradun or Haridwar, all-inclusive packages from ₹19,500. Direct operator, zero commission.',
  ...
  openGraph: { title: 'Char Dham Yatra Package from Mumbai 2026 — Flight, Train & All-Inclusive Tours', description: 'Book Char Dham Yatra from Mumbai 2026. Flight to Dehradun or train to Haridwar. All-inclusive packages from ₹24,999. Delhi/Haridwar pickup. VIP', url: `${SITE.baseUrl}/char-dham-yatra-from-mumbai`, type:'website' },
};
