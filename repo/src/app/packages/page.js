  ...
  return (
    <>
      ...
      <section style={{
        ...
        <img src="https://images.pexels.com/photos/14149541/pexels-photo-14149541.jpeg?auto=compress&cs=tinysrgb&w=1600&h=700&fit=crop"
          alt="" aria-hidden="true" fetchPriority="high" decoding="async"
          style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover', objectPosition:'center 35%' }}/>
        <div aria-hidden="true" style={{ position:'absolute', inset:0,
          background:'linear-gradient(180deg, rgba(5,16,38,0.82) 0%, rgba(5,16,38,0.62) 55%, rgba(5,14,32,0.9) 100%)' }}/>
          ...
          {filtered.length > 0 && (
            <div style={{
              ...
              <div style={{ display:'flex', gap:10, flexWrap:'wrap' }}>
                ...
                <a href='tel:+917817996730' className="btn-outline" style={{ padding:'10px 22px' }}>
                  📞 {SITE.phone}
                </a>
              </div>
            </div>
