...
export const metadata = {
  title: 'Char Dham Yatra Package from Surat 2026 — Distance, Route & Booking',
  description: 'Char Dham Yatra from Surat 2026. Distance to Haridwar: 1,230km. Route via NH48 via Vadodara. All-inclusive packages from ₹24,999/person. Direct operator, zero commission.',
      ...
      <article style={{ maxWidth:900, margin:'0 auto', padding:'36px 20px 60px' }}>
        ...
        <div style={{ background:'var(--navy)', borderRadius:16, padding:'28px 24px', textAlign:'center', marginTop:28 }}>
          ...
          <div style={{ display:'flex', gap:10, justifyContent:'center', flexWrap:'wrap' }}>
            <a href={`https://wa.me/${SITE.whatsapp}?text=${encodeURIComponent('Namaste! I am from Surat and want to book Char Dham Yatra 2026.')}`} target="_blank" rel="noopener noreferrer"
