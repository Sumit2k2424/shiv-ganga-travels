...
export const metadata = {
  title: 'Char Dham Yatra from Ahmedabad 2026 — Packages',
  description: 'Char Dham Yatra from Ahmedabad 2026. Train to Haridwar (18 hrs), all-inclusive packages from ₹19,500. Direct operator, zero commission.',
    ...
    <>
      ...
      <article style={{ maxWidth:900, margin:'0 auto', padding:'36px 20px 60px' }}>
        ...
        <h2 style={{ fontFamily:'var(--font-display)', fontSize:'1.4rem', fontWeight:700, color:'var(--navy)', marginBottom:14, marginTop:32 }}>
          What Char Dham Yatra Includes — From Ahmedabad
        </h2>
        ...
        <div style={{ background:'var(--navy)', borderRadius:16, padding:'28px 24px', textAlign:'center', marginTop:28 }}>
          ...
          <div style={{ display:'flex', gap:10, justifyContent:'center', flexWrap:'wrap' }}>
            <a href={`https://wa.me/${SITE.whatsapp}?text=${encodeURIComponent('Namaste! I am from Ahmedabad and want to book Char Dham Yatra 2026.')}`} target="_blank" rel="nofollow noopener noreferrer"
