...
export const PROSPECTS = [
  ...
  //    people we are trying to outrank — which is the whole argument for them.
  {
    ...
    why: 'The best-established Uttarakhand tourism portal and the centre of this niche’s link graph — six of the eight topical prospects on this register link to it. That authority is real. Whether it can still be obtained is not: see caution.',
    caution: 'The listing surface is gone, not moved. Checked 2026-09-01: /travel-agents/, /tour-operators/, /travel-agent/, /advertise/, /contact/ and /contact-us.php all return 410, and chardham.euttaranchal.com/resources.php 301s to a page that also returns 410. A site that 410s rather than 404s its outbound-listing pages has retired them deliberately. They now sell Char Dham packages themselves on the chardham subdomain, which makes them a booking competitor as much as a portal. Only the contact form at /about_us/contact_us.php survives — so any approach is a cold ask to a competitor, not a directory submission. Do not pitch this as a listing request.',
    evidence: 'Domain live and ranking Aug 2026; /tourism/chard-dham-travel-agents.php returned 410 on 2026-08-27. Six further listing paths confirmed 410 on 2026-09-01; only /, /tourism/, /chardham/ and /about_us/contact_us.php return 200.',
    verified: '2026-09-01: every operator-listing path is 410. No current path exists — the search the earlier caution asked for has been done and came back empty.',
    status: 'open',
  },
  {
    id: 'indiamike',
  ...
  //    a competitor with 7,500 reviews still cannot manufacture.
  {
    ...
    target: '/press',
    why: 'A real regional newspaper covering the yatra every season. An operator who runs the route every season and will go on record is exactly the source a desk needs for a season-open or road-status piece.',
  ...
  // ── Hindi dailies and TV bureaus, added 2026-09-15 ──
  // The English regionals above run a yatra story a week in season; the Hindi
  // dailies' Dehradun and Haridwar bureaus run one a day, and they quote local
  // operators by name on road closures, registration counts and helicopter
  // fraud. None of these want a link; they want a source who picks up the
  // phone. The route in is a bureau reporter's number, then WhatsApp, and the
  // quote comes from Dhanesh under his own name. Links from these are usually
  // nofollow or absent — the value is the named citation that Google, Bing and
  // the AI answers read as a real business being talked about.
  {
    id: 'amar-ujala-uttarakhand',
    name: 'Amar Ujala — Dehradun / Haridwar bureaus',
    domain: 'amarujala.com',
    url: 'https://www.amarujala.com/uttarakhand/dehradun',
    submitUrl: null,
    category: 'press',
    wants: 'quote',
    topical: 0.9, editorial: true, obtainable: 'relationship',
    target: '/char-dham-road-status',
    why: 'The largest Hindi daily in Uttarakhand. Its Dehradun city page carried 32 Char Dham / Kedarnath mentions on the day it was checked; the yatra is its daily beat in season. A Haridwar operator on the route, ex-Army, available on the phone the same hour, is the source a bureau reporter keeps.',
    caution: 'Phone first, then WhatsApp the registrations figures. Never send a press release cold. Quotes on the record under Dhanesh Chandra Mishra only.',
    evidence: 'Uttarakhand edition with per-city pages for Dehradun and Haridwar. Bureau reporter name and number NOT yet obtained.',
    verified: '2026-09-15: /uttarakhand/dehradun and /uttarakhand/haridwar both return 200; the Dehradun page had 32 yatra mentions, the Haridwar page 0 that day (local-crime heavy). Pitch the Dehradun bureau for yatra stories and Haridwar for operator-in-town stories.',
    status: 'open',
  },
  {
    id: 'dainik-jagran-uttarakhand',
    name: 'Dainik Jagran — Haridwar bureau',
    domain: 'jagran.com',
    url: 'https://www.jagran.com/uttarakhand/haridwar',
    submitUrl: null,
    category: 'press',
    wants: 'quote',
    topical: 0.9, editorial: true, obtainable: 'relationship',
    target: '/char-dham-yatra-statistics',
    why: 'Second Hindi daily with a dedicated Haridwar page. Same play as Amar Ujala: be the operator a reporter can call at 7 am when the Kedarnath road shuts.',
    caution: 'Same as Amar Ujala. Do not pitch both bureaus the identical figure on the same day; give each a different angle from the statistics hub.',
    evidence: 'Haridwar city page exists. Bureau contact NOT yet obtained.',
    verified: '2026-09-15: /uttarakhand/haridwar returns 200 with live yatra coverage (2 mentions that day).',
    status: 'open',
  },
  {
    id: 'hindustan-uttarakhand',
    name: 'Hindustan (Live Hindustan) — Haridwar bureau',
    domain: 'livehindustan.com',
    url: 'https://www.livehindustan.com/uttarakhand/haridwar',
    submitUrl: null,
    category: 'press',
    wants: 'quote',
    topical: 0.9, editorial: true, obtainable: 'relationship',
    target: '/char-dham-road-status',
    why: 'Third of the three Hindi dailies with a Haridwar page, and on the day checked the heaviest yatra coverage of the three (30 mentions). Completes the set: one operator quoted across all three is what makes a name familiar to the next reporter.',
    caution: 'Same as above.',
    evidence: 'Haridwar page live with daily yatra items. Bureau contact NOT yet obtained.',
    verified: '2026-09-15: /uttarakhand/haridwar returns 200; 30 Char Dham / Kedarnath mentions on the page that day.',
    status: 'open',
  },
  {
    id: 'etv-bharat-uttarakhand',
    name: 'ETV Bharat Uttarakhand — Hindi TV/digital bureau',
    domain: 'etvbharat.com',
    url: 'https://www.etvbharat.com/hi/uttarakhand',
    submitUrl: null,
    category: 'press',
    wants: 'quote',
    topical: 0.8, editorial: true, obtainable: 'relationship',
    target: '/press',
    why: 'Video-first regional news with a Dehradun bureau. A thirty-second on-camera comment at the office is a story for them, a citation for us, and a clip the YouTube channel can reuse. Their web articles carry the interviewee name and business.',
    caution: 'Camera means the office front, the vehicles and Dhanesh — the same original photographs week 1 of the link plan asks for. Do not do this before those exist.',
    evidence: 'Uttarakhand section live. Bureau contact NOT yet obtained.',
    verified: '2026-09-15: /hi/uttarakhand returns 200 (the older /hi/!state/uttarakhand path is 410). Light yatra coverage on the day (1 mention) — seasonal.',
    status: 'open',
  },
  {
    id: 'news18-uttarakhand',
    name: 'News18 Uttarakhand — Hindi TV/digital bureau',
    ...
    topical: 0.8, editorial: true, obtainable: 'relationship',
    target: '/press',
    why: 'Second regional TV bureau, same play as ETV Bharat, different newsroom.',
    caution: 'Same as ETV Bharat.',
    evidence: 'Uttarakhand section URL NOT confirmed — /uttarakhand/, /uttarakhand-news/ and /state/uttarakhand/ all 404 on 2026-09-15. Find the live section from the site nav before spending time.',
    verified: null,
    status: 'open',
  },
  {
    ...
    target: '/about',
    why: 'Replaces the HARO workflow, which shut down at the end of 2024. Journalists post questions, experts answer, published answers carry a byline and a link. Travel and small-business queries come up regularly and a Himalayan operator who actually runs the route is a genuinely qualified source.',
  ...
  //    now matter as much for AI answers as links do for rankings.
  {
    ...
    target: '/blog/char-dham-yatra-registration',
    why: 'Reddit threads are quoted heavily by ChatGPT, Perplexity and Google AI answers. The registration and road-status pages answer questions that are asked there every season, honestly and without a sales pitch.',
  ...
  },
  {
    ...
    submitUrl: 'https://www.tripadvisor.com/Owners-g616028-d34343558-Shiv_Ganga_Travels-Haridwar_Haridwar_District_Uttarakhand.html',
    category: 'citation',
    wants: 'identity verification, then four corrections',
    topical: 0.9, obtainable: 'open',
    target: '/',
    why: 'Already listed, and the highest-trust profile NRI and foreign pilgrims check before booking. Ranked #41 of 96 Tours & Activities in Haridwar on one review, so there is room to move on volume alone.',
    caution: 'The listing is ALREADY CLAIMED \u2014 the public page says \u201cGet verified to manage this listing\u201d, which reads as unclaimed and is not. The owner portal says \u201cYou\u2019ve claimed this business\u201d and offers a Verify identity button. Identity verification is the only blocker, and only the owner can complete it. Four things then need correcting. (1) About text says \u201cfrom \u20b919,500 per person\u201d, the pre-cut price, against \u20b913,900. (2) Hours 7:00 AM \u2013 9:00 PM against 9 AM \u2013 8 PM \u2014 the same stale figure Google and Bing carry. (3) Contact block is empty. (4) Address on file reads \u201cBhoopatwala\u201d, the identical misspelling GBP has, so both came from one source. Bot-blocked to crawlers; all of this needs a manual login.',
    evidence: 'Owner portal read 2026-09-01: claimed, unverified, Verify identity pending. Public listing 5.0 from one review, #41 of 96 Tours & Activities in Haridwar, \u20b919,500 in About, 7:00 AM \u2013 9:00 PM hours, empty contact block, address on file spells Bhoopatwala.',
    verified: '2026-09-01: claimed but NOT identity-verified. Four corrections queued behind that one step.',
    status: 'open',
  },
  {
    id: 'justdial',
