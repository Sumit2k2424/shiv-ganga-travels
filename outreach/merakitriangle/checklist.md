...
**Prospect:** `merakitriangle`  ·  **Wants:** article  ·  **Route in:** pitch
**Link should point at:** https://www.shivgangatravels.com/char-dham-yatra
**Packet written:** 2026-09-01

## Why this one

MAYBE 48 live, 9 topic terms across Char Dham, Kedarnath and Rishikesh. Links to euttaranchal.com.

## Before you touch it

> 1/5 publication markers — the weakest trust signal of the set. Open it before spending a morning.
...
1. `npm run links:audit -- merakitriangle.com` — confirm it is alive, on-topic, and not already linking to us.
2. Open https://merakitriangle.com/ and read what they actually ask for. This packet is a starting point, not a form filling.
...
6. Set `status: 'submitted'` and `submittedOn: '2026-09-01'` on `merakitriangle` in `scripts/backlinks/prospects.mjs`.
