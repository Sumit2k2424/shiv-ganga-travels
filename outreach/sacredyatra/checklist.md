...
**Prospect:** `sacredyatra`  ·  **Wants:** listing  ·  **Route in:** pitch
**Link should point at:** https://www.shivgangatravels.com/char-dham-yatra
**Packet written:** 2026-09-14

## Why this one

MAYBE 51 live — 16 Char Dham topic terms, the densest topical match of anything the gap surfaced, and the highest Authority Score among the niche finds (37). Links to euttaranchal.com.

## Before you touch it

> 2/5 publication markers. Confirm there is an editor and not just a template.
...
1. `npm run links:audit -- sacredyatra.com` — confirm it is alive, on-topic, and not already linking to us.
2. Open https://sacredyatra.com/ and read what they actually ask for. This packet is a starting point, not a form filling.
...
6. Set `status: 'submitted'` and `submittedOn: '2026-09-14'` on `sacredyatra` in `scripts/backlinks/prospects.mjs`.
