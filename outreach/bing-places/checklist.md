...
**Prospect:** `bing-places`  ·  **Wants:** listing  ·  **Route in:** open
**Link should point at:** https://www.shivgangatravels.com/
**Packet written:** 2026-08-27

## Why this one

Feeds Bing, and through Bing a share of Copilot and ChatGPT web results. Twenty minutes, once.
...
6. Set `status: 'submitted'` and `submittedOn: '2026-08-27'` on `bing-places` in `scripts/backlinks/prospects.mjs`.
