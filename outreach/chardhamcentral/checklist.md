...
**Prospect:** `chardhamcentral`  ·  **Wants:** listing  ·  **Route in:** pitch
**Link should point at:** https://www.shivgangatravels.com/char-dham-yatra
**Packet written:** 2026-09-14

## Why this one

MAYBE 54 live — 11 Char Dham topic terms and 3/5 publication markers, the highest trust signal of the niche sites found. Links to euttaranchal.com.

## Before you touch it

> Check whether it is an operator itself before pitching. A competitor does not list a competitor.
...
1. `npm run links:audit -- chardhamcentral.com` — confirm it is alive, on-topic, and not already linking to us.
2. Open https://chardhamcentral.com/ and read what they actually ask for. This packet is a starting point, not a form filling.
...
6. Set `status: 'submitted'` and `submittedOn: '2026-09-14'` on `chardhamcentral` in `scripts/backlinks/prospects.mjs`.
