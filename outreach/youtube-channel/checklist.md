# YouTube — operator channel

**Prospect:** `youtube-channel`  ·  **Wants:** profile  ·  **Route in:** open
**Link should point at:** https://www.shivgangatravels.com/
**Packet written:** 2026-08-27

## Why this one

Already tier 3 of AUTHORITY-PLAN and still not done. Phone-shot footage of the registration counter, the Kedarnath trek and a real departure day is content nobody else is uploading, and video is what AI summarisers increasingly reach for.

## Before you touch it

> Description links are nofollow. The value is the branded search and the citation, not the link.
...
Evidence on file: n/a — an owned channel, not a placement.

## Steps

1. `npm run links:audit -- youtube.com` — confirm it is alive, on-topic, and not already linking to us.
2. Open https://www.youtube.com/ and read what they actually ask for. This packet is a starting point, not a form filling.
...
6. Set `status: 'submitted'` and `submittedOn: '2026-08-27'` on `youtube-channel` in `scripts/backlinks/prospects.mjs`.
