...
**Link should point at:** https://www.shivgangatravels.com/kedarnath-temple
...
6. Set `status: 'submitted'` and `submittedOn: '2026-09-14'` on `kartikswami` in `scripts/backlinks/prospects.mjs`.
