...
MAYBE 51 live — 15 Char Dham topic terms. Links to discover-uttarakhand.com.

## Before you touch it

> Reads like an operator, which would make it a competitor rather than a prospect. Verify before pitching — this is the entry most likely to be refused on a closer look.
...
1. `npm run links:audit -- aroraholidays.in` — confirm it is alive, on-topic, and not already linking to us.
2. Open https://aroraholidays.in/ and read what they actually ask for. This packet is a starting point, not a form filling.
