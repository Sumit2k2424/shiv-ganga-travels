# Hill Post — Himalayan region news

**Prospect:** `hill-post`  ·  **Wants:** quote  ·  **Route in:** pitch
**Link should point at:** https://www.shivgangatravels.com/char-dham-yatra-statistics
**Packet written:** 2026-09-14

## Why this one

Covers Himalayan states with an appetite for data. The statistics hub was built to be cited and this is the kind of outlet that cites it.

## Before you touch it

> Same rule: the pitch is the dataset, not the company.
...
Evidence on file: Regional news site. Editorial contact NOT verified.

## Steps

1. `npm run links:audit -- hillpost.in` — confirm it is alive, on-topic, and not already linking to us.
2. Open https://hillpost.in/ and read what they actually ask for. This packet is a starting point, not a form filling.
...
6. Set `status: 'submitted'` and `submittedOn: '2026-09-14'` on `hill-post` in `scripts/backlinks/prospects.mjs`.
